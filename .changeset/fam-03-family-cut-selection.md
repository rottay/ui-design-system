...
The frozen Classic and Rustic skins keep reading their own names;
`chrome.surface.popoverShadow` still also writes `--ds-datepicker-panel-shadow`
for the Rustic date panel.
