...
- **Depends on** — WO-GAT-05, WO-GAT-06.
- **Outcome** — Close the 252 canonical Modern families against the 20 operational public controls so a small coherent product surface produces broad, causal, static/DB-equivalent and exactly restorable visual change across primitives, patterns, structures and surfaces.
...
- **Scope** — 252 canonical families; 13 active Standard controls plus seven active Pro capabilities. Static reach, file visitation and old ledger states are prioritization only.
...
- **Acceptance** — Source-bound static/DB parity, intended computed deltas, negative controls, exact restore, applicable resilience stress and final Codex sighted review. Unknown applicability blocks closure.
