...
- Statuses change ONLY through `scripts/maintain/roadmap/commercial-status/index.mjs`
...
> machinery below.
>
> HOW TO PERFORM: (1) WO statuses change ONLY via `node scripts/maintain/roadmap/commercial-status/index.mjs`
...
node scripts/maintain/roadmap/commercial-status/index.mjs next               # actionable WOs (deps satisfied)
node scripts/maintain/roadmap/commercial-status/index.mjs show WO-SHW-01     # full spec block
node scripts/maintain/roadmap/commercial-status/index.mjs delegate WO-SHW-01 # ready-to-paste executor prompt
node scripts/maintain/roadmap/commercial-status/index.mjs claim WO-SHW-01 --by <name>
node scripts/maintain/roadmap/commercial-status/index.mjs done WO-SHW-01 --evidence "<gate + result>"
```
