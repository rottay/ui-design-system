...
//
// Do not add a second Playwright config to this package — e2e/a11y/ and
// e2e/visual/ are the only two spec directories; a11y stays on
// playwright.config.ts, visual stays on this file.
// ---------------------------------------------------------------------------
