...
//     packages/core/artifacts/quality/audits/accessibility/runs/whitelabel/primitives/index.json.
//
...
const LANES: readonly LaneDef[] = [
  { id: 'a', route: '/probe/primitives/display', witness: 'la-avatar', rootTestId: 'la-root' },
  { id: 'b', route: '/probe/primitives/forms', witness: 'lb-input', rootTestId: 'lb-root' },
  { id: 'c', route: '/probe/primitives/feedback', witness: 'lc-alert', rootTestId: 'lc-root' },
];
...
const artifactDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'audits', 'accessibility', 'runs', 'whitelabel', 'primitives');
