...
// packages/core/artifacts/quality/captures/visual-regressions/whitelabel/primitives/states/ as
...
const LANES: readonly LaneDef[] = [
  {
    id: 'a',
    route: '/probe/primitives/display',
    witness: 'la-avatar',
    rootTestId: 'la-root',
    controls: [
      {
  ...
  {
    id: 'c',
    route: '/probe/primitives/feedback',
    witness: 'lc-alert',
    rootTestId: 'lc-root',
    controls: [
      {
...
const artifactDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'captures', 'visual-regressions', 'whitelabel', 'primitives', 'states');
