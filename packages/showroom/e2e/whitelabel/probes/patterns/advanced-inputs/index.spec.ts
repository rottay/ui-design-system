...
// packages/core/artifacts/quality/audits/accessibility/runs/whitelabel/patterns/advanced-inputs/.
//
...
// packages/core/artifacts/quality/captures/visual-regressions/whitelabel/patterns/advanced-inputs/states/.
// ---------------------------------------------------------------------------

type Source = 'bithire-static' | 'themanagement-db';

const ROUTE = '/probe/primitives/advanced-inputs';
...
const axeDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'audits', 'accessibility', 'runs', 'whitelabel', 'patterns', 'advanced-inputs');
const capturesDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'captures', 'visual-regressions', 'whitelabel', 'patterns', 'advanced-inputs', 'states');
const axeReportPath = (): string => join(axeDir(), 'index.json');
