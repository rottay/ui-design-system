...
// Route: /probe/patterns/overlay-notifications (source × locale × density × state × theme cells).
//
// Blocks:
...
//      packages/core/artifacts/quality/captures/visual-regressions/whitelabel/patterns/overlay-notifications/.
// ---------------------------------------------------------------------------
...
const ROUTE = '/probe/patterns/overlay-notifications';
...
const capturesDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'captures', 'visual-regressions', 'whitelabel', 'patterns', 'overlay-notifications');

const axeDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'audits', 'accessibility', 'runs', 'whitelabel', 'patterns', 'overlay-notifications');
