...
// Route: /probe/patterns/content-calendar (source × locale × density × state × theme cells).
//
// Blocks:
...
//      packages/core/artifacts/quality/captures/visual-regressions/whitelabel/patterns/content-calendar/.
// ---------------------------------------------------------------------------
...
const ROUTE = '/probe/patterns/content-calendar';
...
const capturesDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'captures', 'visual-regressions', 'whitelabel', 'patterns', 'content-calendar');

const axeDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'audits', 'accessibility', 'runs', 'whitelabel', 'patterns', 'content-calendar');
