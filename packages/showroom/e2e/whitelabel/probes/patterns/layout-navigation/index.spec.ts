...
// Route: /probe/patterns/layout-navigation (source × locale × density × state cells — the
...
//      packages/core/artifacts/quality/captures/visual-regressions/whitelabel/patterns/layout-navigation/.
// ---------------------------------------------------------------------------
...
const ROUTE = '/probe/patterns/layout-navigation';
...
const capturesDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'captures', 'visual-regressions', 'whitelabel', 'patterns', 'layout-navigation');

const axeDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'audits', 'accessibility', 'runs', 'whitelabel', 'patterns', 'layout-navigation');
