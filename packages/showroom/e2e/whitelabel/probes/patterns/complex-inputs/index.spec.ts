...
// Route: /probe/patterns/complex-inputs (source × locale × density × state × ground cells).
//
// Blocks:
...
//      packages/core/artifacts/quality/captures/visual-regressions/whitelabel/patterns/complex-inputs/.
// ---------------------------------------------------------------------------
...
const ROUTE = '/probe/patterns/complex-inputs';
...
const capturesDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'captures', 'visual-regressions', 'whitelabel', 'patterns', 'complex-inputs');

const axeDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'audits', 'accessibility', 'runs', 'whitelabel', 'patterns', 'complex-inputs');
