...
//
// Axe matrix: the lane probe (/probe/patterns/navigation) × governed source
...
//     packages/core/artifacts/quality/audits/accessibility/runs/whitelabel/patterns/navigation/.
//
...
// packages/core/artifacts/quality/captures/visual-regressions/whitelabel/patterns/navigation/states/.
//
...
const axeDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'audits', 'accessibility', 'runs', 'whitelabel', 'patterns', 'navigation');

const capturesDir = (): string =>
  join(repoRoot(), 'packages', 'core', 'artifacts', 'quality', 'captures', 'visual-regressions', 'whitelabel', 'patterns', 'navigation', 'states');
