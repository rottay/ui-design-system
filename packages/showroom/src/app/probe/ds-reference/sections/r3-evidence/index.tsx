...
/**
 * R3 EVIDENCE — browser scenes for the nine ELEVATED Modern PATTERN families.
 *
...
/** Small fixture-owned readout. Mirrors the r2-elevated / r2-closure idiom. */
...
const TITLES: Record<R3EvidenceCase, string> = {
...
const AXES: Record<R3EvidenceCase, string> = {
...
function CaseBody({ only }: { only: R3EvidenceCase }) {
  switch (only) {
 ...
 */
export function R3EvidenceScene({ only }: { only: R3EvidenceCase }) {
  return (
