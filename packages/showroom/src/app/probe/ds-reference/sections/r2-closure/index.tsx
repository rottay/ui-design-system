...
/**
 * R2 CLOSURE — capture scenes for the seventeen repaired Modern primitive
 * families.
 *
 ...
 *
 * Content is realistic recruiting / venue-management copy on purpose: R2 judges
...
/** Small fixture-owned readout. Mirrors the r2-behavior harness idiom. */
...
export function R2ClosureScene({ only }: { only: R2ClosureCase }) {
  return (
    <SceneFrame title={`R2 CLOSURE - ${only.toUpperCase()}`}>
      {only === 'image-fallback' && (
