...
/* Monochrome framing fixtures, lane A: AsciiFrame, CropMarks, InvertSection,
   SectionFrame, and TextureBackdrop — the five framing families of the cohort.

   Root imports: these are ordinary DS owners now (three layout/display
   primitives and one header structure), not members of a private subpath. */
...
export function ConfigMonochromeASurface({ only }: { only: string }): ReactNode {
  switch (only) {
    case 'ascii-frame':
      return (
...
export const CONFIG_MONOCHROME_A_SLUGS = [
  'ascii-frame',
  'crop-marks',
  'invert-section',
  'section-frame',
