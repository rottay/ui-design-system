...
/**
 * R2 ELEVATED — capture scenes for the nineteen elevated Modern primitive
 * families.
 *
 ...
 *
 * Content is realistic recruiting / venue-operations copy: R2 judges rhythm
...
/** Small fixture-owned readout. Mirrors the r2-closure / r2-behavior idiom. */
...
const TITLES: Record<R2ElevatedCase, string> = {
...
const AXES: Record<R2ElevatedCase, string> = {
...
function CaseBody({ only }: { only: R2ElevatedCase }) {
  switch (only) {
 ...
 */
export function R2ElevatedScene({ only }: { only: R2ElevatedCase }) {
  return (
