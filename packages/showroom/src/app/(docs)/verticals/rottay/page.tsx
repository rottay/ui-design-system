...
import PlatformDashboardDemo from "@/components/demos/rottay/dashboard";
import PlatformTenantFormDemo from "@/components/demos/rottay/tenant-form";
...
const PLATFORM_PROOF_POINTS = [
  {
    ...
    description:
      "Rottay should separate alarms, rollout status, and deeper analysis immediately, even when the runtime flips to a darker or denser shell.",
  },
  {
...
export default function PlatformPage() {
  ...
  return (
    <VerticalShowcaseShell
      name="Rottay"
      slug="rottay"
      heroTitle="Rottay should sell governance-grade product confidence while still adapting cleanly to the active tenant runtime."
