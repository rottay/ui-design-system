 ...
 * -----------------------------------
 * Showroom-owned copy of the The Management Miami regression fixture.
 *
 * Source: packages/core/src/foundation/tokens/ts/presentation/brand-themes/fixtures/themanagementmiami/index.ts
 * Reason: commit 5d2157a8 drained this fixture from the @rottay/design-system
 *         public barrel — tenant-named proof fixtures are not public DS API.
 *         The showroom is its sole consumer, so it now owns the copy.
 * Constraint: this is a checked-in PROBE/regression specimen, never a product
 *         tenant. Values are a faithful copy of the source above (deep-equal
 *         verified). Typed against the public BrandTheme contract only — no deep
 *         import into core source.
 */
