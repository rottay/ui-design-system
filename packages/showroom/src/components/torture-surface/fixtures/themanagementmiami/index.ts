/**
 * PROVENANCE (COPY-FIRST, 2026-07-22)
 * -----------------------------------
 * Showroom-owned mirror of the canonical The Management Miami regression
 * fixture.
 *
 * Canonical source:
...
export const themanagementmiamiBrandTheme: BrandTheme = {
  ...
  chrome: {
    ...
    badge: {
      ...
      selectedShadow:
        "inset 0 0 0 1px rgba(15, 118, 110, 0.14), 0 2px 5px rgba(46, 38, 28, 0.08)",
      iconBg: "#FBF3E7",
      iconBorder: "#9B8A73",
      iconRadius: "2px",
      countBg: "#FBF3E7",
    ...
    controls: {
      ...
      input: {
        ...
        shadowFocus:
          "0 0 0 2px rgba(15, 118, 110, 0.18), 0 4px 12px rgba(46, 38, 28, 0.08)",
        ...
        label: {
          color: "#5C4F3D",
          requiredColor: "#A54432",
          disabledColor: "#8B7C68",
        },
        helper: {
          color: "#74644F",
          errorColor: "#A54432",
        ...
        clear: {
          ...
          borderHover: "#96856D",
          shadowHover: "0 2px 6px rgba(46, 38, 28, 0.12)",
          focusRing: "0 0 0 2px rgba(15, 118, 110, 0.22)",
          activeTransform: "scale(0.92) rotate(-2deg)",
        },
        readOnly: {
          bg: "#FBF8F2",
          color: "#5C4F3D",
