...
// `?dataDisplayStates=1` so no flagship capture sees it. This page is the
...
// component API.
const DATA_DISPLAY_STATE_TREE_DATA: TreeDataNode[] = [
  {
    key: 'documents',
    title: 'Documents',
    children: [
...
export function DataDisplayStates() {
  return (
    <Box
      data-testid="probe-data-display-states"
      style={{
        borderRadius: 16,
    ...
    >
      ...
      >
        <Stack spacing="xs" data-testid="probe-data-display-states-tree">
          <Text size="xs" color="secondary">
            Tree (selected / expanded / disabled / checkable)
          </Text>
          <Tree
            treeData={DATA_DISPLAY_STATE_TREE_DATA}
        ...
        <Stack spacing="xs" data-testid="probe-data-display-states-calendar">
          <Text size="xs" color="secondary">
        ...
        <Stack spacing="xs" data-testid="probe-data-display-states-list">
          <Text size="xs" color="secondary">
        ...
        <Stack spacing="xs" data-testid="probe-data-display-states-timeline">
          <Text size="xs" color="secondary">
        ...
        <Stack spacing="xs" data-testid="probe-data-display-states-descriptions">
          <Text size="xs" color="secondary">
        ...
        <Stack spacing="xs" data-testid="probe-data-display-states-statistic">
          <Text size="xs" color="secondary">
        ...
        <Stack spacing="xs" data-testid="probe-data-display-states-typography">
          <Text size="xs" color="secondary">
          ...
          <Stack spacing="xs">
            ...
            <Link href="/data-display-states-link" color="primary">
              Learn more
            </Link>
          </Stack>
        </Stack>

        <Stack spacing="xs" data-testid="probe-data-display-states-tooltip">
          <Text size="xs" color="secondary">
          ...
          <Box style={{ paddingTop: 32, paddingBottom: 16 }}>
            <Tooltip content="Pinned tooltip content" placement="top">
              <Button data-testid="probe-data-display-states-tooltip-trigger" size="xs">
                Hover me
              </Button>
            </Tooltip>
          </Box>
        ...
        <Stack spacing="xs" data-testid="probe-data-display-states-callout">
          <Text size="xs" color="secondary">
