 ...
 * historical reference-platform evidence for the list-toolbar contract):
 ...
 * page background, results card with static rows beneath — because the sighted
 * review flagged the family evidence as isolated specimens only. The rows
