...
/**
 * Shared entrance-reveal authority for the monochrome surfaces.
 *
 * Spec: docs-engineering/engineering/design-system/commercial-surfaces/README.md section 6
 * (Motion law). One place enforces the two non-negotiables: every reveal collapses to
 * instant-and-visible under `prefers-reduced-motion: reduce`, and nothing loops. Every
 * animated consumer goes through `useReveal` so the law cannot be forgotten per component.
 */
