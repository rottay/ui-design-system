...
import { usePresence } from '@/graphics/motion/react/runtime/presence';
import type { UsePresenceOptions, UsePresenceResult } from '@/graphics/motion/react/runtime/presence';
