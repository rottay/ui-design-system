...
import { ICON_CORPUS, ICON_NAMES, isIconName } from '../../../foundation/registry';
import type { IconName } from '../../../foundation/registry';
import { ICON_PROVENANCE } from '../../../foundation/provenance';
...
describe('semantic Icon accessibility and rendering', () => {
  ...
  it('keeps public props free of supplier types and CSS carries accessibility fallbacks', () => {
    const publicTypes = readFileSync(
      resolve(process.cwd(), 'src/graphics/icons/semantic/foundation/contracts/index.ts'),
      'utf8',
    );
    ...
    const iconCss = readFileSync(
      resolve(process.cwd(), 'src/foundation/tokens/css/presentation/components/semantic-icon/index.css'),
      'utf8',
    );
