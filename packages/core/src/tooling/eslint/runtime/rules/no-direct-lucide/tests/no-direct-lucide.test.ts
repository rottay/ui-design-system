...
describe("no-direct-lucide", () => {
  ...
  it("keeps the legacy DS catalog exemption narrowly scoped", () => {
    const exempt = visitors("/repo/packages/core/src/graphics/icons/presentation/catalog/action/index.ts");
    const semantic = visitors(
      "/repo/packages/core/src/graphics/icons/runtime/semantic/index.ts"
    );
