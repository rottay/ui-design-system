 ...
 *               `scripts/verticals/css-staleness-gate/index.mjs`. That claim is
 ...
 * only by its own definition. `scripts/verticals/css-staleness-gate/index.mjs`
...
export async function runFormulaAgreementDrill() {
  const gateLines = await streamMatchingLines(
    process.execPath,
    ['--test', 'scripts/verticals/css-staleness-gate/index.mjs'],
