 ...
 * own `scripts/verticals/css-staleness-gate/index.mjs` recomposes the five committed
    ...
    return {
      ...
      provenance: {
        ...
        freshnessNote:
          ...
          '`node --test scripts/verticals/css-staleness-gate/index.mjs` — it recomposes these ' +
 ...
 * `scripts/verticals/css-staleness-gate/index.mjs`'s question, and it is deliberately
  ...
  if (shipped.startsWith(fresh)) {
    return {
      ...
      meaning:
        ...
        'remainder is the sanctioned spring block is scripts/verticals/css-staleness-gate/index.mjs\'s ' +
