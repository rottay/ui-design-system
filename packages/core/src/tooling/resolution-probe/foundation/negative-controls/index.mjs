 ...
 * from `manifest/controls/<control-id>.json#calibration.negativeControls`, and
 * narrowed by `manifest/families/<family>.json#themeControls[].negativeControls`
 ...
 * translation is data (`vocabulary.json`) rather than code, and it is
...
const VOCABULARY = JSON.parse(readFileSync(resolve(HERE, 'vocabulary.json'), 'utf-8'));
