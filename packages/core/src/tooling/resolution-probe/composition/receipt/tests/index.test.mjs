...
import { sightedApprovers } from '../../../../../../scripts/quality-evidence/v2/receipts.mjs';
 ...
 * `SIGHTED_APPROVER = 'Codex (DT)'` and the single drill here passed `'Codex'`.
 * Two defects at once:
 *
 ...
 *      2026-08-23 moved the DT seat to Kimi K3 and left Codex a read-only
...
test('fence drills (c)(d)(e): a RETIRED seat, and the auditor, pass the fence', () => {
  withTempRoot(({ root, contracts }) => {
    ...
    // (c) and (d): the names the constant used to hold. Codex left the DT seat
    ...
    // (e) `Fable 5` is the closure auditor, which is NOT the sighted approver
    ...
    for (const producer of ['Codex', 'Codex (DT)', 'Fable 5']) {
      assert.ok(
