 ...
 * that a validator recomputes. `evidence-contract.json` already states the law
 ...
 * `scripts/quality-evidence/v2/receipts.mjs` already implements the validator.
 *
...
import {
  computeSourceDigest,
  validateReceipt,
} from '../../../../../scripts/quality-evidence/v2/receipts.mjs';
import {
  loadProgramContracts,
  REPOSITORY_ROOT,
} from '../../../../../scripts/quality-evidence/v2/contracts.mjs';
import { CORE_ROOT } from '../../foundation/paths/index.mjs';
import { sha256 } from '../../runtime/bundle/index.mjs';

/** Mirrors `evidence-contract.json#schemaVersion`; a receipt states which law it was written under. */
export const RECEIPT_SCHEMA_VERSION = 2;

/** This instrument's own tree, repo-relative. */
export const INSTRUMENT_ROOT = 'packages/core/src/tooling/resolution-probe';
...
/**
 * Builds a receipt that satisfies `evidence-contract.json#receiptRequiredFields`
