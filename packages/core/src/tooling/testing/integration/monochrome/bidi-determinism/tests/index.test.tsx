...
import { MonoStat } from '../../../../../../ui/patterns/data/mono-stat';
import { TreeViewConnector } from '../../../../../../ui/patterns/visualization/tree-view/presentation/connector';
...
const treeViewCss = readFileSync(resolve(SKIN_DIR, 'tree-view-connector.css'), 'utf8');
const monoStatSource = readFileSync(
  resolve(SOURCE_ROOT, 'ui/patterns/data/mono-stat/index.tsx'),
  'utf8',
);
