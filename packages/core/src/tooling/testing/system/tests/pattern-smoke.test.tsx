...
describe('pattern smoke coverage', () => {
  beforeAll(async () => {
    await Promise.all([
      import('../../../../ui/patterns/data/detail-panel/engines/classic'),
      import('../../../../ui/patterns/data/detail-panel/engines/modern'),
      import('../../../../ui/patterns/data/detail-panel/engines/rustic'),
    ]);
  });
