...
export const themanagementmiamiBrandTheme: BrandTheme = {
  ...
  // The same Art Deco palette, lifted for AA text/non-text contrast on the
  // dark canvas instead of reusing the light-ground seeds. It used to sit in
  // `dark*Color` fields on the base palette, which no block could reach; as a
  // mode overlay it compiles into a real `[data-theme='dark']` block.
  modes: {
    dark: {
      palette: {
        primaryColor: "#4FB3AA",
