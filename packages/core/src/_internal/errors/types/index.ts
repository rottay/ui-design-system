...
export interface UseErrorHandlerOptions {
  /** Category to filter errors by, or 'all' for all errors */
...
export interface UseErrorHandlerReturn {
  /** Report a new error to the error handler */
  reportError: (error: DSErrorInput) => void;
  /** Get the current error log (read-only) */
