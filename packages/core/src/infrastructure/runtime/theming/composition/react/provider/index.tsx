...
} from '../../../../../compilers/kernel/foundation/css/color-math';
...
// compilers/kernel/foundation/css/color-math — single canonical implementation shared
...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    if (tokenOverrides?.glass) {
      ...
      // precedence CSS offers. `infrastructure/compilers/kernel/runtime/brand-theme` already guards this way,
    ...
    if (tokenOverrides?.gradients) {
      ...
      // Same rule as the glass block above and as `infrastructure/compilers/kernel/runtime/brand-theme`.
