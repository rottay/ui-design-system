 ...
 * around it that IS wired into `compileTheme`: merged under the
...
describe('deriveExtendedPaletteFloor · authored-over-derived precedence, live through compileTheme', () => {
  // This used to simulate the merge order by hand (`composeFloorThenAuthored`)
  // because the floor was computed but not yet wired into compileTheme's
