/**
 * @fileoverview Typography sub-owner: the font families and the two metrics a
 * governed pairing shares with an authored typography block.
 *
 * @module Compilers/Theme/Lowering/Runtime/derivation/typography/pairing
 * @category Compilers
...
/**
 * The families and their tracking/leading, resolved once.
 *
 * The three vertical-level statements -- profile pairing, authored pairing,
 * authored literal -- resolve HERE, in that order; the tenant's own pairing
 * and literals are a separate family one rank up, so the contest between
