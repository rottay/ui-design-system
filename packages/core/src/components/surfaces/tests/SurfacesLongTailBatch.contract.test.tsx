...
// long-tail skin ownership pre-migration anatomy contract (Units I-1, I-3, I-4, I-5).
//
...
//
// Paths are relative to `src/components/surfaces`. The six `../structures/...` entries
...
// covers them because the long-tail anatomy contract is about rendered anatomy, which the
...
describe('long-tail anatomy source census', () => {
...
describe('long-tail anatomy foundation anatomy (I-1)', () => {
...
describe('long-tail anatomy layout and workspace anatomy (I-3)', () => {
...
describe('long-tail anatomy admin/data thin-tail anatomy (I-4)', () => {
...
describe('long-tail anatomy experience/operations thin-tail anatomy (I-5)', () => {
