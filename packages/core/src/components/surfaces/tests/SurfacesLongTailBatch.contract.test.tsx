...
import { HeaderSurface } from '../layout/header';
import { SidebarSurface } from '../layout/sidebar';
import { AuditSurface } from '../pages/admin/audit';
import { BillingSurface } from '../pages/admin/billing';
import { ImportExportSurface } from '../pages/admin/import-export';
import { IntegrationSurface } from '../pages/admin/integration';
import { ProfileSurface } from '../pages/admin/profile';
import { SettingsSurface } from '../pages/admin/settings';
import { TeamSurface } from '../pages/admin/team';
import { CompareSurface } from '../pages/data/compare';
import { DashboardSurface } from '../pages/data/dashboard';
import { ListSurface } from '../pages/data/list';
import { ReportSurface } from '../pages/data/report';
import { SearchSurface } from '../pages/data/search';
import { VisualizationSurface } from '../pages/data/visualization';
import { AuthSurface } from '../pages/experience/auth';
import { ChatSurface } from '../pages/experience/chat';
import { EditorSurface } from '../pages/experience/editor';
import { MarketingSurface } from '../pages/experience/marketing';
import { MediaSurface } from '../pages/experience/media';
import { NotificationSurface } from '../pages/experience/notification';
import { PricingSurface } from '../pages/experience/pricing';
import { ActivitySurface } from '../pages/operations/activity';
import { KanbanSurface } from '../pages/operations/kanban';
import { CollectionWorkspaceSurface } from '../pages/workspace/collection-workspace';
import { CollectionRenderDispatch } from '../pages/workspace/collection-workspace/render-dispatch';
import { CommandCenterSurface } from '../pages/workspace/command-center';
import { DecisionInboxSurface } from '../pages/workspace/decision-inbox';
import { RecordWorkbenchSurface } from '../pages/workspace/record-workbench';
...
// sibling PatternsLongTailBatch contract. Foundation keeps its two state files
// separate because both export independently rendered anatomy islands.
const CK_I_RENDERABLE_SOURCES = [
  'foundation/personality-helpers',
  'foundation/shared',
  'foundation/states/index',
  'foundation/states/surface-states',
  ...
  'workspace/collection-workspace/render-dispatch',
