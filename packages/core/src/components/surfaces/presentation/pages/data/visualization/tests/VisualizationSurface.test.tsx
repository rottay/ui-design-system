...
import visualizationSkinCss from '@/foundation/tokens/css/presentation/components/skin/visualization/index.css?raw';
import chartFoundationCss from '@/foundation/tokens/css/presentation/components/skin/chart-foundation/index.css?raw';
