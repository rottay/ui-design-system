      ...
      config={{
        ...
        presentation: {
          ...
          hero: (
            <Stack spacing="sm">
              <Badge>Events</Badge>
              <Text>Brand storytelling stays visible even when the shell collapses.</Text>
            </Stack>
          ),
        },
        behavior: {},
...
export const MobileTabletDesktop: Story = {
  render: () => (
    <SurfaceStoryProvider productProfile="events.organizer">
      <Stack spacing="xl">
        <StoryViewport label="Mobile · 375px" width={375}>
          <ResponsiveSearchExample />
        </StoryViewport>
        <StoryViewport label="Tablet · 768px" width={768}>
          <ResponsiveSidebarExample />
        </StoryViewport>
        <StoryViewport label="Desktop · 1280px" width={1280}>
          <ResponsiveAuthExample />
        </StoryViewport>
      </Stack>
