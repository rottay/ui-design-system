...
import { createSurfaceStoryDecorator } from './story-helpers';
...
const sampleNotifications = [
  {
    ...
    message: 'Bob Smith has joined the Platform Engineering team.',
  ...
  },
  {
    ...
    action: { label: 'View Deployment', onClick: () => console.log('View deployment') },
  },
  {
    id: 'n3',
    title: 'Storage quota warning',
    message: 'Your workspace is using 92% of available storage.',
  ...
  },
  {
    ...
    message: 'Build #1847 failed on branch feature/auth-refactor.',
  ...
  },
  {
    ...
    message: 'Invoice #INV-2026-0043 has been generated and sent.',
    timestamp: 'Yesterday',
    read: true,
    type: 'info' as const,
  },
...
export const AllRead: Story = {
  args: {
    config: {
      visual: { layout: 'sections' },
      presentation: {
        chrome: { title: 'Notifications', subtitle: 'All caught up' },
      },
      behavior: {
