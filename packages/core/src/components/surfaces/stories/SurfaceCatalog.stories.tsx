            ...
            behavior: {
              ...
              steps: [
                ...
                },
                {
                  key: 'review',
                  title: 'Review',
                  content: <Text>Review configuration before launch.</Text>,
                },
              ],
              submitAction: {
                id: 'launch',
          ...
          config={{
            ...
            behavior: {
              items: [
                {
                  id: 'm1',
                  src: createPosterDataUri('Hero Shot'),
                  title: 'Hero shot',
                  description: 'Stage lighting setup',
                },
                {
                  id: 'm2',
                  src: createPosterDataUri('Crowd', '#f97316', '#ec4899'),
                  title: 'Crowd',
                  description: 'Audience angle',
                },
              ],
            },
          }}
                ...
                rows: [
                  {
                    ...
                    values: {
                      starter: 'Core',
                      enterprise: 'Core + advanced',
                    },
                  },
                  {
                    key: 'theming',
                    label: 'Tenant theming',
                    values: {
                      starter: 'Basic tokens',
                      enterprise: 'Full profile + overrides',
                    },
                  },
                ],
              },
      ...
      <OnboardingSurface
        config={{
          ...
          presentation: {
            ...
            checklist: (
              <Stack spacing="xs">
                <Text>1. Choose profile</Text>
                <Text>2. Brand tenant</Text>
                <Text>3. Configure surfaces</Text>
              </Stack>
            ),
          },
          behavior: {
            ...
            steps: [
              {
                key: 'brand',
                title: 'Brand',
                fields: [{ name: 'tenantName', label: 'Tenant name', type: 'text' }],
              },
              {
                key: 'review',
                title: 'Review',
                content: <Text>Everything is ready for launch.</Text>,
              },
            ],
          },
        }}
      ...
      <AuthSurface
        config={{
          ...
          presentation: {
            ...
            hero: (
              <Stack spacing="sm">
                <Badge>Events Organizer</Badge>
                <Text>Brand expression stays in the app or profile layer.</Text>
              </Stack>
            ),
            form: (
              <Stack spacing="md">
                <Box>Email field</Box>
                <Box>Password field</Box>
