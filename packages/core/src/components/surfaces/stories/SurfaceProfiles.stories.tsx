    ...
    <VisualizationSurface
      config={{
        ...
        presentation: {
          chrome: {
            title: 'Weekly Trend',
            subtitle: 'The same surface reads a different profile personality.',
          },
          aside: (
            <PatternStatsGrid
              stats={[
                { key: 'active', label: 'Active', value: 1240 },
                { key: 'new', label: 'New', value: 76 },
              ]}
              columns={1}
              variant="glass"
            />
          ...
          views: [
            {
              key: 'line',
              label: 'Line',
              content: <LineChart title="Throughput" series={revenueSeries} showArea />,
            },
            {
              key: 'area',
              label: 'Area',
              content: <AreaChart title="Momentum" series={revenueSeries} />,
            },
          ],
          stats: [
...
export const RecruitingVsEvents: Story = {
  render: () => (
    <div style={{ display: 'grid', gap: 32 }}>
      ...
      >
        <Stack spacing="md">
          <Text style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            Recruiting.Operator
          </Text>
