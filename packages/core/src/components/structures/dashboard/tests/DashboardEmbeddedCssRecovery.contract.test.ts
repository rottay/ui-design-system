...
const ACTIVITY_CSS_PATH = '../../../../foundation/tokens/css/presentation/components/skin/dashboard-activity-interactions/index.css';
const METRICS_CSS_PATH = '../../../../foundation/tokens/css/presentation/components/skin/dashboard-metrics-interactions/index.css';
const DATA_TERMINAL_CSS_PATH = '../../../../foundation/tokens/css/presentation/components/skin/data-terminal-card-keyframes/index.css';
const STATS_HEADER_CSS_PATH = '../../../../foundation/tokens/css/presentation/components/skin/stats-header-keyframes/index.css';
const DATA_TERMINAL_SKIN_PATH = '../../../../foundation/tokens/css/presentation/components/skin/data-terminal-card/index.css';
const STATS_HEADER_SKIN_PATH = '../../../../foundation/tokens/css/presentation/components/skin/stats-header/index.css';
