...
const ACTIVITY_CSS_PATH = '../../../../tokens/css/components/skin/dashboard-activity-interactions.css';
const METRICS_CSS_PATH = '../../../../tokens/css/components/skin/dashboard-metrics-interactions.css';
const DATA_TERMINAL_CSS_PATH = '../../../../tokens/css/components/skin/data-terminal-card-keyframes.css';
const STATS_HEADER_CSS_PATH = '../../../../tokens/css/components/skin/stats-header-keyframes.css';

const COMPONENT_SOURCES = [
  '../dashboard-insights/activity/cards/index.tsx',
  '../dashboard-insights/activity/compact/index.tsx',
  '../dashboard-insights/activity/ticker/index.tsx',
  '../dashboard-insights/activity/timeline/index.tsx',
  '../dashboard-insights/metrics/cards/index.tsx',
  '../dashboard-insights/metrics/chart/index.tsx',
  '../dashboard-insights/metrics/minimal/index.tsx',
  '../dashboard-insights/metrics/rows/index.tsx',
...
const INTERACTION_COMPONENTS = [
  {
    sourcePath: '../dashboard-insights/activity/cards/index.tsx',
    cssPath: ACTIVITY_CSS_PATH,
    scope: 'ds-activity-cards',
  },
  {
    sourcePath: '../dashboard-insights/activity/compact/index.tsx',
    cssPath: ACTIVITY_CSS_PATH,
    scope: 'ds-activity-compact',
  },
  {
    sourcePath: '../dashboard-insights/activity/ticker/index.tsx',
    cssPath: ACTIVITY_CSS_PATH,
    scope: 'ds-activity-ticker',
  },
  {
    sourcePath: '../dashboard-insights/activity/timeline/index.tsx',
    cssPath: ACTIVITY_CSS_PATH,
    scope: 'ds-activity-timeline',
  },
  {
    sourcePath: '../dashboard-insights/metrics/cards/index.tsx',
    cssPath: METRICS_CSS_PATH,
    scope: 'ds-metrics-cards',
  },
  {
    sourcePath: '../dashboard-insights/metrics/chart/index.tsx',
    cssPath: METRICS_CSS_PATH,
    scope: 'ds-metrics-chart',
  },
  {
    sourcePath: '../dashboard-insights/metrics/minimal/index.tsx',
    cssPath: METRICS_CSS_PATH,
    scope: 'ds-metrics-minimal',
  },
  {
    sourcePath: '../dashboard-insights/metrics/rows/index.tsx',
    cssPath: METRICS_CSS_PATH,
...
const LIVE_ANIMATION_CONSUMERS = [
  ...
  },
  {
    ...
    path: '../stats-header/StatsHeader.tsx',
