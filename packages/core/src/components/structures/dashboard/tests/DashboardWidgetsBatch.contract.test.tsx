...
// ---------------------------------------------------------------------------
// dashboard anatomy -- dashboard-widgets family data-part contract.
//
...
// onto all ten dashboard anatomy files WITHOUT moving any paint. This file proves each
...
describe('DashboardWidgets data-part contract (dashboard anatomy)', () => {
  // -------------------------------------------------------------------------
