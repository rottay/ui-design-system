...
const SKIN = '../../../../../foundation/tokens/css/presentation/components/skin/stats-header/index.css';
const KEYFRAMES =
  '../../../../../foundation/tokens/css/presentation/components/skin/stats-header-keyframes/index.css';
