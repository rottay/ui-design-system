...
describe('WO-CRA-14 WorkspaceShell ParticleField quarantine', () => {
  ...
  it('keeps ParticleField behind the lazy boundary and pins CollectionWorkspace forwarding', () => {
    const shellSource = readFileSync(
      resolve(
        process.cwd(),
        'src/components/structures/shell/workspace-shell/index.tsx',
      ),
      'utf8',
    );
    const shellSkin = readFileSync(
      resolve(process.cwd(), 'src/foundation/tokens/css/presentation/components/skin/collection-shell/index.css'),
      'utf8',
    );
    const consumableRottaySkin = readFileSync(
      resolve(process.cwd(), 'artifacts/generated/css/verticals/rottay/index.css'),
      'utf8',
    );
    ...
    const collectionWorkspaceSource = readFileSync(
      resolve(
        process.cwd(),
        'src/components/surfaces/presentation/pages/workspace/collection-workspace/index.tsx',
      ),
      'utf8',
    );
    ...
    expect(consumableRottaySkin).toContain('.ds-collection-shell__static-particle-field');
