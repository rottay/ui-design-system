...
import { RecordSummaryStrip, RecordFieldGrid, RecordField, RecordActionBar, RecordPanel } from '../record';
import {
  InlineEditorGroup,
  InlineEditor,
  InlineEditGrid,
...
import { GuidedDraftFormSurface } from '../../../surfaces/pages/forms/guided-draft-form';
import type { FormSection } from '../../../surfaces/pages/forms/guided-draft-form';
import { FormSurface } from '../../../surfaces/pages/forms/form';
import { WizardSurface } from '../../../surfaces/pages/forms/wizard';
import { DetailFormSurface } from '../../../surfaces/pages/forms/detail-form';
import type { FormSurfaceConfig, WizardSurfaceConfig, DetailFormSurfaceConfig } from '../../../surfaces/foundation/types';
