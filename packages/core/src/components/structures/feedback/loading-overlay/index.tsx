 ...
 * `presentation/components/skin/loading-overlay/index.css` (identical keyframes,
 ...
 * independent code audit to the skin-owned form (same migration contract the skin documents
