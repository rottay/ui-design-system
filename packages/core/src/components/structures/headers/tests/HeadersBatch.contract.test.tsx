...
// ---------------------------------------------------------------------------
// structure-header anatomy -- the structures/headers half of the header
...
// the DOM (P-79's own lesson from record anatomy: tsc accepts the stamp everywhere,
 ...
 * `data-part`. See the README's "A surface owns no DOM" law and record-and-form anatomy's
...
describe('Headers-family (structures) data-part contract (structure-header anatomy)', () => {
