 ...
 * Component exports.
 *
 * This barrel aggregates the three component tiers (`primitives`, `patterns`,
 * `surfaces`) into a single import surface. The whole component catalog is
 * available from the package root (`@rottay/design-system`) as a flat export.
 *
 * There is intentionally **no** public `@rottay/design-system/components`,
 * `@rottay/design-system/components/primitives`,
 * `@rottay/design-system/components/patterns`, or
