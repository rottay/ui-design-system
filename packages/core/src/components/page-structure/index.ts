/**
 * @fileoverview Page Structure tier barrel — Tier 2.5 of the design system.
 *
 * The `page-structure` tier sits between `patterns` (engine-agnostic compositions)
 * and `surfaces` (page-level config objects). It hosts page-page-structure
 ...
 * and surfaces — consumers never see a `page-structure/` path in their import
 * statements.
 *
 * See `ARCHITECTURE.md` for the full tier model and the rules for what
 * belongs in page-structure vs pattern vs surface.
 */
...
export * from './dashboard-insights'; // was patterns/command-header-variants
