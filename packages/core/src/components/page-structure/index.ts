 ...
 *
 * The `page-structure` tier sits between `patterns` (engine-agnostic
 * compositions) and `surfaces` (page-level config objects). It hosts
 * page-structure families organized into 5 groups:
 *
 ...
 * and surfaces — consumers never see a `page-structure/` path in their
 * import statements.
 */
