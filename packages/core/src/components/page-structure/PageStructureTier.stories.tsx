/**
 * @fileoverview Page Structure tier Storybook landing page.
 *
...
function PageStructureTierIndex() {
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', maxWidth: 800, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 8 }}>Page Structure</h1>
      <p style={{ color: '#666', marginBottom: 24, lineHeight: 1.6 }}>
        Page-structure families that sit between <strong>patterns</strong> (task-level compositions)
        ...
        <tbody>
          {FAMILIES.map((f) => (
            <tr key={f.folder} style={{ borderBottom: '1px solid #f0f0f0' }}>
              ...
              <td style={{ padding: '8px 12px', fontFamily: 'monospace', fontSize: 12, color: '#888' }}>page-structure/{f.folder}/</td>
      ...
      <p style={{ marginTop: 24, fontSize: 13, color: '#999' }}>
        See <code>docs/page-structure-tier.md</code> for the full guide including the
...
const meta: Meta = {
  title: 'PageStructure/Overview',
  component: PageStructureTierIndex,
  parameters: {
    layout: 'padded',
    docs: { description: { component: 'Index page listing all page-structure-tier families.' } },
  },
};
