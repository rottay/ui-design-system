 ...
 * foundation/tokens/css/runtime/engines/rustic/skin/badge/index.css for why.
 */
...
export default function RusticBadge(props: BadgeProps): React.ReactElement {
  ...
  // (foundation/tokens/css/runtime/engines/rustic/skin/badge/index.css) both read this, so a badge
   ...
   * foundation/tokens/css/runtime/engines/rustic/skin/badge/index.css, so its :hover rule can
  ...
  // foundation/tokens/css/runtime/engines/rustic/skin/badge/index.css, which reads the custom properties
