...
import { BADGE_DEFAULTS, VARIANT_COLOR_MAP, VARIANT_SOFT_COLOR_MAP, VARIANT_SOFT_TEXT_COLOR_MAP, SIZE_MAP, TONE_TO_BADGE_VARIANT } from '../../contracts';
    ...
    return (
      <>
        ...
        {/*
          ...
          in this fix's fence to hold an unlayered rule (foundation/tokens/css/runtime/engines/
