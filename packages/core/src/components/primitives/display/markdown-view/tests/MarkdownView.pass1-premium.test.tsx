...
// owned by the family skin (presentation/components/skin/markdown-view/index.css).
...
const skin = readFileSync(
  join(
    __dirname,
    '../../../../../foundation/tokens/css/presentation/components/skin/markdown-view/index.css',
  ),
  'utf8',
);
