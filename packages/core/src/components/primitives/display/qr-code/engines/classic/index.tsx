 ...
 * Delegates to `antd/qr-code` for real Reed-Solomon QR encoding, error
...
/**
 * Classic QRCode engine. Wraps `antd/qr-code` with DS prop normalization.
 ...
 * @returns A wrapper div containing the `antd/qr-code` component.
 */
