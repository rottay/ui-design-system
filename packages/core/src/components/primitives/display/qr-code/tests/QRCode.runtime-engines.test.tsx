...
describe('modern QRCode chrome (K4-C)', () => {
  ...
  const modernSkin = readFileSync(
    resolve(__dirname, '../../../../../foundation/tokens/css/runtime/engines/modern/skin/qrcode/index.css'),
    'utf8',
  );
  ...
  it('pins the expired-state contrast model (K4-C round 2, axe remediation)', () => {
    ...
    const componentTokens = readFileSync(
      resolve(__dirname, '../../../../../foundation/tokens/css/presentation/components/qrcode/index.css'),
      'utf8',
    );
