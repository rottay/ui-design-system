 ...
 * modern skin (`foundation/tokens/css/runtime/engines/modern/skin/image/index.css`).
...
import { ActionZoomInIcon } from '@/graphics/icons/semantic/generated/roles/action-zoom-in';
