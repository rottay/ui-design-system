...
/**
 * Titan Tree component using Ant Design.
 *
 * @example
 * ```tsx
 * <TitanTree
 ...
 * ```
 */
export default function TitanTree(props: TreeProps): React.ReactElement {
  const {
    treeData,
  ...
  return (
    <AntTree
      ...
      className={`rottay-tree rottay-tree--titan ${className || ''}`}
      style={style}
    >
      {children}
    </AntTree>
...
TitanTree.displayName = 'Tree.Titan';
