...
/**
 * Hermes Engine implementation of the Statistic component.
 *
...
Statistic.displayName = 'Statistic.Hermes';
...
/**
 * Hermes Engine implementation of the Countdown component.
 *
...
Countdown.displayName = 'Statistic.Countdown.Hermes';
