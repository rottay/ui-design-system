...
const ApolloTooltip = forwardRef<HTMLDivElement, TooltipProps>(
  (props, ref) => {
    ...
    const tooltipStyle: React.CSSProperties = {
      position: 'absolute',
      ...placementStyle,
      marginTop: placement.startsWith('bottom') ? 'var(--ds-tooltip-offset, 8px)' : undefined,
      marginBottom: placement.startsWith('top') ? 'var(--ds-tooltip-offset, 8px)' : undefined,
      marginLeft: placement.startsWith('right') ? 'var(--ds-tooltip-offset, 8px)' : undefined,
      marginRight: placement.startsWith('left') ? 'var(--ds-tooltip-offset, 8px)' : undefined,
    ...
    return (
      <div
        ref={ref}
        className={`rottay-tooltip rottay-tooltip--apollo ${className}`}
