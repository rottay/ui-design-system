...
describe('Card Pass 1 primitive contract', () => {
  ...
  it('ships motion/accessibility gates without a chromatic side rail', () => {
    const skin = readFileSync(
      join(__dirname, '../../../../../foundation/tokens/css/runtime/engines/modern/skin/card/index.css'),
      'utf-8',
    );
    const compounds = readFileSync(
      join(__dirname, '../../../../../foundation/tokens/css/presentation/components/skin/card-compounds/index.css'),
      'utf-8',
    );
    const css = `${skin}\n${compounds}`;
