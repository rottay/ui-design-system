 ...
 * `foundation/base/typography/index.css`, so the reference is bare (fallback
 ...
 * `data-color` by `foundation/tokens/css/runtime/engines/modern/skin/typography/index.css`, which resolves
