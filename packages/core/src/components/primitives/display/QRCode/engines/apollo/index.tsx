/**
 * QRCode - Apollo Engine (Pure HTML/CSS/Canvas)
 *
...
/**
 * Apollo QRCode component using pure HTML/CSS/Canvas.
 *
 * @example
 * ```tsx
 * <ApolloQRCode value="https://example.com" />
 * ```
 */
export default function ApolloQRCode(props: QRCodeProps): React.ReactElement {
  const {
    value,
  ...
  return (
    <div
      className={`rottay-qrcode rottay-qrcode--apollo ${className || ''}`}
...
ApolloQRCode.displayName = 'ApolloQRCode';
