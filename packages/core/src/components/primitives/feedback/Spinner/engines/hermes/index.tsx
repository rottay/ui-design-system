/**
 * @fileoverview Spinner Hermes Engine - Rottay Design System
 ...
 *
 * @remarks
 * The Hermes engine leverages DaisyUI's loading utilities, providing:
 ...
 *
 * // Hermes engine for Tailwind projects
 * <Spinner engine="hermes" size="lg" label="Loading..." />
 * ```
 *
 * @see {@link https://daisyui.com/components/loading/} DaisyUI Loading documentation
 *
 * @module Spinner/Engines/Hermes
 * @category Feedback
...
/**
 * Hermes (DaisyUI) implementation of the Spinner component.
 *
 * @description
 ...
 * @example
 * ```tsx
 * <HermesSpinner size="lg" label="Processing..." />
 * ```
 */
