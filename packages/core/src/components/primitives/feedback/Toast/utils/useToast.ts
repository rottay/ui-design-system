...
// ============================================================================
// Standalone Toast Methods
// ============================================================================

/**
 * Storage for standalone toast methods.
...
/**
 * Sets the toast methods for standalone usage.
 *
 * @description
 * Called internally by ToastProvider to enable the standalone
 * toast object to function. Not typically called by consumers.
 *
 * @param methods - Toast methods from context
 *
 * @internal
 */
 ...
 *
 * @description
 * Returns the toast methods if ToastProvider has been mounted.
 *
 * @returns Toast methods or null if not initialized
 *
 * @internal
 */
