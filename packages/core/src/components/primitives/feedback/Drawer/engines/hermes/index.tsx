 ...
 *
 * <Drawer engine="hermes" open={open} onClose={onClose}>
...
/**
 * Size preset mappings for Hermes engine.
...
/**
 * Hermes Engine implementation of the Drawer component.
 *
 * @description
