/**
 * @fileoverview Drawer Titan Engine - Rottay Design System
 ...
 * Titan drawers inherit Ant Design's theme tokens which can be
 ...
 * ```tsx
 * <Drawer engine="titan" open={open} onClose={onClose}>
 ...
 * @see {@link ApolloDrawer} - Vanilla alternative
 * @see {@link https://ant.design/components/drawer} - Ant Design Drawer docs
 * @module Drawer/Engines/Titan
 * @category Feedback
...
/**
 * Titan Engine implementation of the Drawer component.
 *
 * @description
