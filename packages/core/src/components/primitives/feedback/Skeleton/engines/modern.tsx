        ...
        style={{
          ...
          borderRadius: variant === 'circular'
            ...
            : variant === 'rounded'
              ...
              : '0',
          animationDuration: 'var(--ds-skeleton-animation-duration, var(--ds-motion-slow, 1.5s))',
          animationTimingFunction: 'var(--ds-skeleton-animation-easing, var(--ds-motion-ease-in-out, ease-in-out))',
        }}
      />
    );
  }
  ...
  return (
    <div className={`flex gap-4 ${className}`} style={style}>
      ...
      <div className="flex-1 space-y-2">
        ...
        {title && <div className="skeleton" style={{ height: '1.25rem', width: '60%', background: 'var(--ds-skeleton-bg, var(--ds-color-neutral-100))', animationDuration: 'var(--ds-skeleton-animation-duration, var(--ds-motion-slow, 1.5s))', animationTimingFunction: 'var(--ds-skeleton-animation-easing, var(--ds-motion-ease-in-out, ease-in-out))' }} />}
        ...
        {paragraph &&
          Array.from({
            ...
            <div
              key={i}
              className="skeleton"
              style={{ height: '1rem', width: i === rows! - 1 ? '80%' : '100%', background: 'var(--ds-skeleton-bg, var(--ds-color-neutral-100))', animationDuration: 'var(--ds-skeleton-animation-duration, var(--ds-motion-slow, 1.5s))', animationTimingFunction: 'var(--ds-skeleton-animation-easing, var(--ds-motion-ease-in-out, ease-in-out))' }}
            />
          ))}
      </div>
    </div>
