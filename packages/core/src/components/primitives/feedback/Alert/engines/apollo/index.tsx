/**
 * @fileoverview Alert Apollo Engine - Rottay Design System
 ...
 *
 * <Alert engine="apollo" type="success" message="Profile updated!" />
 * ```
 *
 ...
 *   '--radius-md': '8px',
 * }}>
 *   <Alert engine="apollo" type="info" message="Custom styled alert" />
 * </div>
 * ```
 *
 ...
 * @see {@link HermesAlert} - DaisyUI alternative
 * @module Alert/Engines/Apollo
 * @category Feedback
...
/**
 * Apollo Engine implementation of the Alert component.
 *
 * @description
