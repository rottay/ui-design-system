/**
 * @fileoverview Result Titan Engine - Rottay Design System
 ...
 * Titan results inherit Ant Design's theme tokens which can be
 ...
 * ```tsx
 * <Result engine="titan" status="error" title="Submission Failed">
...
/**
 * Titan Engine implementation of the Result component.
 *
 * @description
