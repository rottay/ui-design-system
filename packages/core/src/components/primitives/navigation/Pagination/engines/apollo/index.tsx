/**
 * @fileoverview Pagination Apollo Engine - Rottay Design System
 ...
 *
 * @remarks
 * The Apollo engine implements pagination using only native HTML and CSS:
 ...
 *
 * @module Pagination/Engines/Apollo
 * @category Navigation
...
/**
 * Apollo engine implementation of Pagination.
 *
 * @description
