...
/**
 * @fileoverview BackTop Titan Engine - Rottay Design System
 ...
 *
 * @remarks
 * The Titan engine leverages Ant Design's FloatButton.BackTop component for:
 ...
 * ```tsx
 * <BackTop engine="titan" visibilityHeight={200} />
 * ```
 *
...
/**
 * Titan (Ant Design) implementation of BackTop.
 *
 * @description
 ...
 *
 * @remarks
 * The duration prop is only supported in the Titan engine as it's
