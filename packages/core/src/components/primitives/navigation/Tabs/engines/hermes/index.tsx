 ...
 *
 * @remarks
 * The Hermes engine uses DaisyUI's tab classes combined with Tailwind
 * utilities for styling. This results in a smaller bundle size compared
 * to Titan while maintaining visual consistency with the design system.
 *
...
/**
 * Hermes engine implementation of Tabs.
 *
 * @description
