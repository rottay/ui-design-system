/**
 * @fileoverview Tabs Titan Engine - Rottay Design System
 ...
 *
 * @remarks
 * The Titan engine wraps Ant Design's Tabs component, adapting it to
...
/**
 * Titan engine implementation of Tabs.
 *
 * @description
