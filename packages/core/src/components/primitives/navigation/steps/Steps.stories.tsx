...
import { EngineComparison as EngineComparisonHelper, VariantEngineMatrix } from '../../../../../.storybook/components';
...
/**
 * Side-by-side comparison of Steps across all 3 engines.
 */
export const CompareEngines: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Compare the same Steps rendered by Classic (Ant Design), Modern (DaisyUI), and Rustic (Vanilla CSS).',
      },
    },
  },
  render: () => (
