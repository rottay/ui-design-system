...
import type { IconName } from '@/graphics/icons/semantic/foundation/registry';
import type { IconMirroring } from '@/graphics/icons/semantic/foundation/contracts';
 ...
 * (`presentation/components/icon-frame/index.css`), so tenants can reshape it
