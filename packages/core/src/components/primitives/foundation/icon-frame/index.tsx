 ...
 *
 * It is the sanctioned raw-element tier (SemanticSurface/code-block/resize-handle
 ...
 * `foundation/tokens/css/presentation/components/icon-frame/index.css` through the
...
import type { IconSizeToken } from '@/graphics/icons/glyphs/foundation';
