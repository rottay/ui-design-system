 ...
 *
 * It is the sanctioned raw-element tier (SemanticSurface/code-block/
 ...
 * (`presentation/components/meter/index.css` composing the shared
 * `presentation/components/arc/index.css` substrate); the TSX stamps data
