/**
 * @fileoverview Radio Rustic Engine - Rottay Design System
...
export function RusticRadioGroup(props: RadioGroupProps): React.ReactElement {
  const {
  ...
  return (
    <div
      className={`rottay-radio-group rottay-radio-group--rustic ${className}`}
      style={groupStyle}
      role="radiogroup"
...
RusticRadio.Group = RusticRadioGroup;
