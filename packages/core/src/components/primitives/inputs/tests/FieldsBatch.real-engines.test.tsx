...
const SKINS: Record<string, string> = {
  'modern/form-field': read('runtime/engines/modern/skin/form-field/index.css'),
  'rustic/form-field': read('runtime/engines/rustic/skin/form-field/index.css'),
  'modern/textarea': read('runtime/engines/modern/skin/textarea/index.css'),
  'rustic/textarea': read('runtime/engines/rustic/skin/textarea/index.css'),
  'modern/tag-input': read('runtime/engines/modern/skin/tag-input/index.css'),
  'rustic/tag-input': read('runtime/engines/rustic/skin/tag-input/index.css'),
  'modern/input-number': read('runtime/engines/modern/skin/input-number/index.css'),
  ...
  'rustic/radio': read('runtime/engines/rustic/skin/radio/index.css'),
  'modern/checkbox': read('runtime/engines/modern/skin/checkbox/index.css'),
  'rustic/checkbox': read('runtime/engines/rustic/skin/checkbox/index.css'),
  'modern/slider': read('runtime/engines/modern/skin/slider/index.css'),
  'rustic/slider': read('runtime/engines/rustic/skin/slider/index.css'),
  'modern/otp-input': read('runtime/engines/modern/skin/otp-input/index.css'),
  'rustic/otp-input': read('runtime/engines/rustic/skin/otp-input/index.css'),
  'modern/form': read('runtime/engines/modern/skin/form/index.css'),
  'rustic/form': read('runtime/engines/rustic/skin/form/index.css'),
  ...
  'rustic/input-residual': read('runtime/engines/rustic/skin/input-residual/index.css'),
  'radio-group': read('presentation/components/skin/radio-group/index.css'),
  'checkbox-group': read('presentation/components/skin/checkbox-group/index.css'),
  'button-icon': read('presentation/components/skin/button-icon/index.css'),
  'voice-input-button': read('presentation/components/skin/voice-input-button/index.css'),
  'input-compounds': read('presentation/components/skin/input-compounds/index.css'),
};
...
describe('fields skins -- per-component interaction + keyframe pins', () => {
  ...
  it('Button.Icon: optical CSS stays compound-only and interaction paint comes from Modern Button', () => {
    const modernButton = read('runtime/engines/modern/skin/button/index.css');
