 ...
 * pseudo-classes -- see `foundation/tokens/css/runtime/engines/rustic/skin/button/index.css` for why the
...
const RusticButton = forwardRef<HTMLButtonElement, ButtonProps>(
  (props, ref) => {
    ...
    // Paint lives in `foundation/tokens/css/runtime/engines/rustic/skin/button/index.css`, keyed on the
