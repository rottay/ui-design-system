 ...
 * (`foundation/tokens/css/runtime/engines/modern/skin/password-input/index.css`), keyed
...
import { ActionConcealIcon } from '@/graphics/icons/semantic/generated/roles/action-conceal';
