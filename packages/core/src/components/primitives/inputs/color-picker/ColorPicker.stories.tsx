...
import type { Color, ColorFormat } from './contracts';
import { DesignSystemProvider } from '../../../../infrastructure/runtime/bootstrap';
import { EngineComparison, VariantEngineMatrix } from '../../../../../.storybook/components';
...
export const CompareEngines: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Compare the same ColorPicker rendered by Classic (Ant Design), Modern (DaisyUI), and Rustic (Vanilla CSS).',
      },
    },
  },
  render: () => (
