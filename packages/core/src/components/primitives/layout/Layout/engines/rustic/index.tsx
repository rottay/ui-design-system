...
const styles = {
  ...
  header: {
    backgroundColor: 'var(--ds-layout-header-bg, #001529)',
    color: 'var(--ds-layout-header-color, #fff)',
  ...
  sider: {
    backgroundColor: 'var(--ds-layout-sider-bg, #001529)',
    color: 'var(--ds-layout-sider-color, #fff)',
    flexShrink: 0,
    overflow: 'auto',
    transition: 'width 0.3s',
  } as React.CSSProperties,
  siderLight: {
    backgroundColor: 'var(--ds-layout-sider-light-bg, #fff)',
    color: 'var(--ds-layout-sider-light-color, #000)',
    borderRight: '1px solid var(--ds-layout-sider-light-border, var(--ds-color-neutral-100, #f0f0f0))',
  } as React.CSSProperties,
  content: {
    flex: 1,
    padding: 'var(--ds-layout-content-padding, 16px)',
    overflow: 'auto',
    backgroundColor: 'var(--ds-layout-content-bg, #fff)',
  } as React.CSSProperties,
  footer: {
    backgroundColor: 'var(--ds-layout-footer-bg, var(--ds-color-neutral-100, #f5f5f5))',
