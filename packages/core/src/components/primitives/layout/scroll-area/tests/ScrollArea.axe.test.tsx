...
/**
 * ScrollArea landmark-law axe proof (K3-C independent code audit remediation).
 *
 * independent code audit blocked this family: every instance rendered `role="region"` with
