...
export const Ratios: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 300 }}>
      <AspectRatio ratio={1}><PlaceholderContent label="1:1 Square" /></AspectRatio>
      <AspectRatio ratio={4/3}><PlaceholderContent label="4:3" /></AspectRatio>
      <AspectRatio ratio={16/9}><PlaceholderContent label="16:9" /></AspectRatio>
      <AspectRatio ratio={21/9}><PlaceholderContent label="21:9 Ultra Wide" /></AspectRatio>
    </div>
  ),
};
...
export const CompareEngines: Story = {
  ...
  render: () => (
    <EngineComparison
      component={AspectRatio}
      props={{ ratio: 16/9, maxWidth: '300px', children: <PlaceholderContent label="16:9" /> }}
      showDescriptions
    />
  ),
};
