...
export const TablePlRouteManager = createPreset<PlRouteManagerProps>({
  name: 'PlRouteManager.Table',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlRouteManagerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Route Manager</h2>
