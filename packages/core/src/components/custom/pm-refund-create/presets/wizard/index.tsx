...
export const WizardPmRefundCreate = createPreset<PmRefundCreateProps>({
  name: 'PmRefundCreate.Wizard',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmRefundCreateProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Refund Create</h2>
