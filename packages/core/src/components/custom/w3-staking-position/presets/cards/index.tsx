...
/**
 * W3StakingPosition - Cards Preset
...
export const CardsW3StakingPosition = createPreset<W3StakingPositionProps>({
  name: 'W3StakingPosition.Cards',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3StakingPositionProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Staking Position</h2>
