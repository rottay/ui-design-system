...
/**
 * PlImpersonationManager - Panel Preset
...
export const PanelPlImpersonationManager = createPreset<PlImpersonationManagerProps>({
  name: 'PlImpersonationManager.Panel',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlImpersonationManagerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Impersonation Manager</h2>
