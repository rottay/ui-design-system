...
/**
 * W3AnalyticsDashboard - Dashboard Preset
...
export const DashboardW3AnalyticsDashboard = createPreset<W3AnalyticsDashboardProps>({
  name: 'W3AnalyticsDashboard.Dashboard',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3AnalyticsDashboardProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Web3 Analytics</h2>
