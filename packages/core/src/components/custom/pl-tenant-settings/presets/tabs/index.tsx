...
/**
 * PlTenantSettings - Tabs Preset
 * Configure tenant-level settings including branding, domains, and defaults
 */
...
export const TabsPlTenantSettings = createPreset<PlTenantSettingsProps>({
  name: 'PlTenantSettings.Tabs',
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Tenant Settings</h2>
