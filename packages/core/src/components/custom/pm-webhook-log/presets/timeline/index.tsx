...
export const TimelinePmWebhookLog = createPreset<PmWebhookLogProps>({
  name: 'PmWebhookLog.Timeline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmWebhookLogProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Webhook Log</h2>
