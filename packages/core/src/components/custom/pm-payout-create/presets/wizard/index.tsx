...
export const WizardPmPayoutCreate = createPreset<PmPayoutCreateProps>({
  name: 'PmPayoutCreate.Wizard',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmPayoutCreateProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Payout Create</h2>
