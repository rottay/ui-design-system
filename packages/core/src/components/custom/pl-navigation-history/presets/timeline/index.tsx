...
/**
 * PlNavigationHistory - Timeline Preset
...
export const TimelinePlNavigationHistory = createPreset<PlNavigationHistoryProps>({
  name: 'PlNavigationHistory.Timeline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlNavigationHistoryProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Navigation History</h2>
