...
/**
 * PlNotificationDeliveryLog - Table Preset
...
export const TablePlNotificationDeliveryLog = createPreset<PlNotificationDeliveryLogProps>({
  name: 'PlNotificationDeliveryLog.Table',
