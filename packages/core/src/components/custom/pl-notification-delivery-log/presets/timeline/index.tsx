...
/**
 * PlNotificationDeliveryLog - Timeline Preset
...
export const TimelinePlNotificationDeliveryLog = createPreset<PlNotificationDeliveryLogProps>({
  name: 'PlNotificationDeliveryLog.Timeline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlNotificationDeliveryLogProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Notification Delivery Log</h2>
