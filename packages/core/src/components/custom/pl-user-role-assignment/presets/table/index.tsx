...
/**
 * PlUserRoleAssignment - Table Preset
...
export const TablePlUserRoleAssignment = createPreset<PlUserRoleAssignmentProps>({
  name: 'PlUserRoleAssignment.Table',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlUserRoleAssignmentProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>User Role Assignment</h2>
