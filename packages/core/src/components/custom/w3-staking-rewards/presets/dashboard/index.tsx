...
/**
 * W3StakingRewards - Dashboard Preset
...
export const DashboardW3StakingRewards = createPreset<W3StakingRewardsProps>({
  name: 'W3StakingRewards.Dashboard',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3StakingRewardsProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Staking Rewards</h2>
