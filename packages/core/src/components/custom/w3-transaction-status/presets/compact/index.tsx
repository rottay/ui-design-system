...
/**
 * W3TransactionStatus - Compact Preset
...
export const CompactW3TransactionStatus = createPreset<W3TransactionStatusProps>({
  name: 'W3TransactionStatus.Compact',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3TransactionStatusProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Transaction Status</h2>
