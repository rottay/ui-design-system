...
/**
 * PmPaymentStatus - Tracker Preset
...
export const TrackerPmPaymentStatus = createPreset<PmPaymentStatusProps>({
  name: 'PmPaymentStatus.Tracker',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmPaymentStatusProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Payment Status</h2>
