...
export const VisualPlMenuEditor = createPreset<PlMenuEditorProps>({
  name: 'PlMenuEditor.Visual',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlMenuEditorProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Menu Editor</h2>
