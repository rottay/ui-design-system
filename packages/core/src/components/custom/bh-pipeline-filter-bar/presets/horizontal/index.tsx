...
export const HorizontalBhPipelineFilterBar = createPreset<BhPipelineFilterBarProps>({
  ...
  render: (ctx: PresetContext<BhPipelineFilterBarProps>) => {
    ...
    const activeFilters = Array.isArray(rawActiveFilters) ? rawActiveFilters : [];
    const savedPresets = Array.isArray(rawSavedPresets) ? rawSavedPresets : [];
