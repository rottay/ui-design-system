...
/**
 * PlNotificationAnalytics - Report Preset
...
export const ReportPlNotificationAnalytics = createPreset<PlNotificationAnalyticsProps>({
  name: 'PlNotificationAnalytics.Report',
