...
/**
 * PlNotificationTemplateEditor - Preview Preset
...
export const PreviewPlNotificationTemplateEditor = createPreset<PlNotificationTemplateEditorProps>({
  name: 'PlNotificationTemplateEditor.Preview',
