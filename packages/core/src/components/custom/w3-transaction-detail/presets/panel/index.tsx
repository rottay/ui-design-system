...
/**
 * W3TransactionDetail - Panel Preset
...
export const PanelW3TransactionDetail = createPreset<W3TransactionDetailProps>({
  name: 'W3TransactionDetail.Panel',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3TransactionDetailProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Transaction Detail</h2>
