...
/**
 * PmRefundCalculator - Calculator Preset
...
export const CalculatorPmRefundCalculator = createPreset<PmRefundCalculatorProps>({
  name: 'PmRefundCalculator.Calculator',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmRefundCalculatorProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Refund Calculator</h2>
