...
/**
 * W3WalletBalance - Portfolio Preset
...
export const PortfolioW3WalletBalance = createPreset<W3WalletBalanceProps>({
  name: 'W3WalletBalance.Portfolio',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3WalletBalanceProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Wallet Balance</h2>
