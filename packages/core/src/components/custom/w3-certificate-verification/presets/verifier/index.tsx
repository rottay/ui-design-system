...
/**
 * W3CertificateVerification - Verifier Preset
...
export const VerifierW3CertificateVerification = createPreset<W3CertificateVerificationProps>({
  name: 'W3CertificateVerification.Verifier',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3CertificateVerificationProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Certificate Verification</h2>
