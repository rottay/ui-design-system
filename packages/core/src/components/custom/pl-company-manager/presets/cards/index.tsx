...
/**
 * PlCompanyManager - Cards Preset
 * Manage companies within a tenant with contact info and user assignments
 */
...
export const CardsPlCompanyManager = createPreset<PlCompanyManagerProps>({
  name: 'PlCompanyManager.Cards',
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Company Manager</h2>
