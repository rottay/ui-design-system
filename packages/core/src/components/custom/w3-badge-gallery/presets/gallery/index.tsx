...
export const GalleryW3BadgeGallery = createPreset<W3BadgeGalleryProps>({
  name: 'W3BadgeGallery.Gallery',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3BadgeGalleryProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Badge Gallery</h2>
