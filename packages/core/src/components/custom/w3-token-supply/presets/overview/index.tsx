...
export const OverviewW3TokenSupply = createPreset<W3TokenSupplyProps>({
  name: 'W3TokenSupply.Overview',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3TokenSupplyProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Token Supply</h2>
