...
export const InlineW3GasEstimator = createPreset<W3GasEstimatorProps>({
  name: 'W3GasEstimator.Inline',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3GasEstimatorProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Gas Estimator</h2>
