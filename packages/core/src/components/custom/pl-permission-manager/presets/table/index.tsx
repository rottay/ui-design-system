...
/**
 * PlPermissionManager - Table Preset
...
export const TablePlPermissionManager = createPreset<PlPermissionManagerProps>({
  name: 'PlPermissionManager.Table',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlPermissionManagerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Permission Manager</h2>
