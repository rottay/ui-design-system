...
/**
 * PmPaymentMethodSelector - Grid Preset
...
export const GridPmPaymentMethodSelector = createPreset<PmPaymentMethodSelectorProps>({
  name: 'PmPaymentMethodSelector.Grid',
