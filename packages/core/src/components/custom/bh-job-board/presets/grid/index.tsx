...
export const GridBhJobBoard = createPreset<BhJobBoardProps>({
  ...
  render: ({ primitives, props, tokens, engine }: PresetContext<BhJobBoardProps>) => {
            ...
            <div style={{ position: 'relative' as const }}>
              <button
                ...
                style={{
                  ...
                  fontSize: tokens.typography.fontSize.xs,
                  fontWeight: tokens.typography.fontWeight.medium,
                  border: `${tokens.surface.borderWidth} ${tokens.surface.borderStyle} ${filters.clientId ? tokens.colors.primaryScale[300] : tokens.colors.neutral[200]}`,
    ...
    const renderJobCard = (job: JobItem) => {
      ...
      const cardBaseStyle = useMemo(() => createCardStyle(tokens, {
