...
/**
 * W3StakingPoolDeploy - Wizard Preset
...
export const WizardW3StakingPoolDeploy = createPreset<W3StakingPoolDeployProps>({
  name: 'W3StakingPoolDeploy.Wizard',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3StakingPoolDeployProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Staking Pool Deploy</h2>
