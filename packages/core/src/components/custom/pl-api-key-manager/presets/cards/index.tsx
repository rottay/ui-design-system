...
/**
 * PlApiKeyManager - Cards Preset
 * Generate, revoke, and manage API keys with scopes and expiration dates
 */
...
export const CardsPlApiKeyManager = createPreset<PlApiKeyManagerProps>({
  name: 'PlApiKeyManager.Cards',
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>API Key Manager</h2>
