...
/**
 * PlTenantPlanManager - Comparison Preset
...
export const ComparisonPlTenantPlanManager = createPreset<PlTenantPlanManagerProps>({
  name: 'PlTenantPlanManager.Comparison',
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Tenant Plan Manager</h2>
