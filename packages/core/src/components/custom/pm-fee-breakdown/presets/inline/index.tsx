...
export const InlinePmFeeBreakdown = createPreset<PmFeeBreakdownProps>({
  name: 'PmFeeBreakdown.Inline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmFeeBreakdownProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Fee Breakdown</h2>
