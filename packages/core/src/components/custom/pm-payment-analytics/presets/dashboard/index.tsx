...
/**
 * PmPaymentAnalytics - Dashboard Preset
...
export const DashboardPmPaymentAnalytics = createPreset<PmPaymentAnalyticsProps>({
  name: 'PmPaymentAnalytics.Dashboard',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmPaymentAnalyticsProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Payment Analytics</h2>
