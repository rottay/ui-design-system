...
/**
 * PmSubscriptionLifecycle - Compact Preset
...
export const CompactPmSubscriptionLifecycle = createPreset<PmSubscriptionLifecycleProps>({
  name: 'PmSubscriptionLifecycle.Compact',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmSubscriptionLifecycleProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Subscription Lifecycle</h2>
