...
/**
 * PmTrialManager - Overview Preset
...
export const OverviewPmTrialManager = createPreset<PmTrialManagerProps>({
  name: 'PmTrialManager.Overview',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmTrialManagerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Trial Manager</h2>
