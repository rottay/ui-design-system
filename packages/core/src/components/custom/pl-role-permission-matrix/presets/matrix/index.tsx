...
/**
 * PlRolePermissionMatrix - Matrix Preset
...
export const MatrixPlRolePermissionMatrix = createPreset<PlRolePermissionMatrixProps>({
  name: 'PlRolePermissionMatrix.Matrix',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlRolePermissionMatrixProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Role Permission Matrix</h2>
