...
/**
 * W3PaymentSession - Tracker Preset
...
export const TrackerW3PaymentSession = createPreset<W3PaymentSessionProps>({
  name: 'W3PaymentSession.Tracker',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3PaymentSessionProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Payment Session</h2>
