...
/**
 * PmSubscriptionDetail - Timeline Preset
...
export const TimelinePmSubscriptionDetail = createPreset<PmSubscriptionDetailProps>({
  name: 'PmSubscriptionDetail.Timeline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmSubscriptionDetailProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Subscription Detail</h2>
