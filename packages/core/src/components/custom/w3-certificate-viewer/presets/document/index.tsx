...
/**
 * W3CertificateViewer - Document Preset
...
export const DocumentW3CertificateViewer = createPreset<W3CertificateViewerProps>({
  name: 'W3CertificateViewer.Document',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3CertificateViewerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Certificate Viewer</h2>
