...
const SKINS = {
  modern: readFileSync(tokens('runtime/engines/modern/skin/data-table/index.css'), 'utf8'),
  rustic: readFileSync(tokens('runtime/engines/rustic/skin/data-table/index.css'), 'utf8'),
  mobile: readFileSync(tokens('presentation/components/skin/data-table-mobile/index.css'), 'utf8'),
};
const CARD_CSS = [
  readFileSync(tokens('runtime/engines/modern/skin/card/index.css'), 'utf8'),
  readFileSync(tokens('runtime/engines/rustic/skin/card/index.css'), 'utf8'),
];
const INTERACTION_CSS = readFileSync(tokens('presentation/components/skin/data-table-interactions/index.css'), 'utf8');
