...
async function preloadOverlayEngine(engine: StableEngineName): Promise<void> {
  switch (engine) {
    case 'classic':
      await Promise.all([
        import('@/components/primitives/feedback/modal/engines/classic'),
        import('@/components/primitives/feedback/drawer/engines/classic'),
        import('@/components/primitives/overlay/sheet/engines/classic'),
      ]);
      return;
    case 'modern':
      await Promise.all([
        import('@/components/primitives/feedback/modal/engines/modern'),
        import('@/components/primitives/feedback/drawer/engines/modern'),
        import('@/components/primitives/overlay/sheet/engines/modern'),
      ]);
      return;
    case 'rustic':
      await Promise.all([
        import('@/components/primitives/feedback/modal/engines/rustic'),
        import('@/components/primitives/feedback/drawer/engines/rustic'),
        import('@/components/primitives/overlay/sheet/engines/rustic'),
      ]);
  }
}
