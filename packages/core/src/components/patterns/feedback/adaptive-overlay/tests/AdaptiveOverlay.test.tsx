...
vi.mock('@/infrastructure/runtime/responsive', () => ({
...
vi.mock('@/components/primitives/feedback/Modal', () => {
...
vi.mock('@/components/primitives/feedback/Drawer', () => {
  const MockDrawer = ({
    open,
    onClose,
    children,
...
vi.mock('@/components/primitives/overlay/sheet', () => {
  const MockSheet = ({
    open,
    onOpenChange,
    children,
