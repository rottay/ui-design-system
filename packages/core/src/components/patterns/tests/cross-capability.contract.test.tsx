...
import { PatternFileManager } from '../data/file-manager';
import { PatternUserProfileCard } from '../identity/profile/user-profile-card';
import { PatternPricingTable } from '../commerce/pricing-table';
import { PatternEmptyState } from '../feedback/empty-state';
import { TokenInspector } from '../customization/token-inspector';
import { renderWithEngine } from '@tests/support/engine';

// ---------------------------------------------------------------------------
// cross-capability anatomy -- cross-capability pattern anatomy contract.
//
...
describe('file-manager -- data-part contract (cross-capability anatomy)', () => {
...
describe('user-profile-card -- data-part contract (cross-capability anatomy)', () => {
...
describe('pricing-table -- data-part contract (cross-capability anatomy)', () => {
...
describe('empty-state -- data-part contract (cross-capability anatomy)', () => {
...
describe('token-inspector -- createElement DOM contract (cross-capability anatomy)', () => {
