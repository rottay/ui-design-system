...
/**
 * @fileoverview WorkspaceFilterRail pattern -- horizontal active filter chip
...
export interface WorkspaceActiveFilter {
...
export interface WorkspaceFilterRailProps {
  activeFilters: WorkspaceActiveFilter[];
