...
/**
 * @fileoverview WorkspaceCommandBar pattern -- premium command/search bar
...
export interface WorkspaceCommandBarConfig {
  placeholder: string;
  value: string;
  onSearch: (query: string) => void;
  hint?: string;
  suggestions?: WorkspaceCommandSuggestion[];
  recentQueries?: WorkspaceCommandSuggestion[];
}

export interface WorkspaceCommandBarProps {
  command: WorkspaceCommandBarConfig;
...
export function WorkspaceCommandBar({
  ...
  const handleSuggestionSelect = (suggestion: WorkspaceCommandSuggestion) => {
