...
describe('SankeyChart categorical paint', () => {
  it('cycles the resolved palette in node order and wraps at the categorical size', () => {
  ...
  it('lets a declared node colour win over the cycle', () => {
  ...
  // categorical size paints more than CHART_CATEGORICAL_SIZE distinct nodes.
