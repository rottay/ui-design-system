...
const capabilityContract = [
  ...
  typeContract<Equal<CapabilitiesOf<FunnelChartProps>, Legend | Colors | Scheme | Margin>>(),
  typeContract<Equal<CapabilitiesOf<GanttChartProps>, Colors | Scheme | Margin>>(),
  ...
  typeContract<Equal<CapabilitiesOf<NetworkGraphProps>, Legend | Colors | Scheme>>(),
  ...
  typeContract<Equal<CapabilitiesOf<SankeyChartProps>, Legend | Colors | Scheme | Margin>>(),
  typeContract<Equal<CapabilitiesOf<ScatterChartProps>, Legend | Colors | Scheme | Margin | CompactActivation>>(),
