...
// ---------------------------------------------------------------------------
// navigation-pattern anatomy -- the patterns/navigation family
...
//
//   1. ALL FIVE COMPONENTS HAVE REAL modern AND rustic ENGINES. Unlike shell-header anatomy
...
describe('command-palette -- data-part contract (navigation-pattern anatomy)', () => {
...
describe('environment-toggle -- data-part contract (navigation-pattern anatomy)', () => {
...
describe('workspace-switcher -- data-part contract (navigation-pattern anatomy)', () => {
...
describe('shortcuts-overlay -- data-part contract (navigation-pattern anatomy)', () => {
...
// ===========================================================================
describe('locale-switcher -- data-part contract (navigation-pattern anatomy)', () => {
  it.each(ENGINES)('stamps every part + active/focused state on open (%s)', async (engine) => {
    const { container } = renderWithEngine(
