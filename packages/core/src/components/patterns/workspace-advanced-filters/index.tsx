...
/**
 * @fileoverview WorkspaceAdvancedFilters pattern -- premium filter card grid
 ...
 *   - WorkspaceAdvancedFilters: flat single-field equality with optional
...
export interface WorkspaceFilterPreset {
  key: string;
  label: string;
  values: Record<string, string>;
}

export interface WorkspaceFilterVisual {
  icon: ReactNode;
  description: string;
}

export interface WorkspaceAdvancedFiltersProps {
  filters: WorkspaceFilterDefinition[];
  presets?: WorkspaceFilterPreset[];
  values: Record<string, string>;
   ...
   * description.
   */
  filterVisuals?: Record<string, WorkspaceFilterVisual>;
}
...
function defaultFilterVisual(fallbackLabel: string): WorkspaceFilterVisual {
  return {
