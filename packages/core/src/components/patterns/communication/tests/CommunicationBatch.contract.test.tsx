...
// ---------------------------------------------------------------------------
// communication-pattern anatomy -- the patterns/communication family
...
//
// P-79 SURVIVAL IS NOT UNIFORM IN THIS FAMILY -- unlike navigation-pattern anatomy (zero DS
// primitives, raw DOM only) and dashboard anatomy (only Box/Text/Flex/Stack, which all
...
describe('comment-thread -- data-part contract (communication-pattern anatomy)', () => {
...
describe('notification-center -- data-part contract (communication-pattern anatomy)', () => {
...
describe('activity-log -- data-part contract (communication-pattern anatomy)', () => {
  it.each(ENGINES)('stamps root/dot/line/diff/avatar/badge/entity/timestamp (%s)', async (engine) => {
    ...
    // ['modern'] because rustic does not implement the communication-pattern anatomy data-parts this
...
describe('live-feed -- data-part contract (communication-pattern anatomy)', () => {
...
// ===========================================================================
describe('assistant -- data-part contract (communication-pattern anatomy)', () => {
...
// forwarding primitives per the dashboard anatomy precedent).
// ===========================================================================
describe('presence -- data-part contract (communication-pattern anatomy)', () => {
