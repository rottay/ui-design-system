                ...
                <div
                  ...
                  style={{
                    ...
                    background: isFocused
                      ? 'var(--ds-color-neutral-100, #f3f4f6)'
                      : isActive
                      ? 'var(--ds-color-primary-50, rgba(59,130,246,0.04))'
                      : undefined,
                    borderLeft: isActive
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 'var(--ds-font-size-xs, 11px)', color: 'var(--ds-color-text-muted)' }}>
                      ...
                      {typeof ws.online === 'number' && (
                        <span style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                          <span style={{ width: 5, height: 5, borderRadius: '50%', background: 'var(--ds-color-success, #22c55e)', display: 'inline-block' }} />
                          {ws.online}
                        </span>
                      )}
                    </div>
              ...
              <div style={{ padding: '6px 12px' }}>
                <button
                  style={{
                    ...
                    padding: '6px 12px',
                    background: 'none',
                    border: '1px dashed var(--ds-color-neutral-300, #d1d5db)',
            ...
            <>
              ...
              >
                <div style={{
                  ...avatarStyle(28),
                  borderRadius: '50%',
                  background: 'var(--ds-color-accent, #7c3aed)',
                }}>
                  {currentUser.avatar ? (
                    <img
