...
/**
 * @fileoverview StatsHeader — structures-tier stat-card strip.
 ...
 * sparkline dots, progress bars, and contextual insight lines. It lives in
 * `ui/structures/dashboard/` alongside the other dashboard chrome families.
 *
...
import type { StatsHeaderProps } from './contracts';

export type { StatsHeaderProps, StatItem, AccentColor } from './contracts';
