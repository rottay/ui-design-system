 ...
 * @module Structures/Feedback/SurfaceLifecycle/SurfaceErrorBoundary
 * @category Structures
 * @package @rottay/design-system
 *
 * @remarks
 * It belongs to `structure/feedback/surface-lifecycle`, beside the five states
 * and the state machine, because it handles the one lifecycle outcome the
 * machine cannot observe: a throw during render, which never reaches an
 * `error` prop. It used to sit on the `surfaces/runtime` support path, which
 * made it a public component no family row could claim -- and put the crash
 * fallback a tier away from the error state it stands in for.
 */
