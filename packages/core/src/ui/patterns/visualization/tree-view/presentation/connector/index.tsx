import type { TreeViewConnectorNode, TreeViewConnectorProps } from './contracts';
...
/* Connector glyphs and label stay separate elements so tree-view-connector.css can pin the
   connector's bidi direction and mirror its geometry without touching the label. */
export function TreeViewConnector({
  data,
  className,
  "aria-label": ariaLabel,
}: TreeViewConnectorProps): React.JSX.Element {
...
export type { TreeViewConnectorNode, TreeViewConnectorProps } from './contracts';
