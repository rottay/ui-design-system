...
import type { MonoStatProps } from './contracts';
...
/**
 * Ease-out cubic. Approximates the canon's ease-out feel (`--ds-ease-out`, a
 ...
 *
 * Built for the monochrome "proof wall" (e.g. `601` use cases, `9` modules, `130`
...
export type { MonoStatProps } from './contracts';
