...
const SOURCES: ReadonlyArray<{ path: string; layerRank: number }> = [
  {
    path: "src/foundation/tokens/css/presentation/components/skin/record-facts.css",
    layerRank: 0,
  },
  {
    path: "src/foundation/tokens/css/runtime/engines/modern/skin/record-facts.css",
    layerRank: 1,
  },
];
