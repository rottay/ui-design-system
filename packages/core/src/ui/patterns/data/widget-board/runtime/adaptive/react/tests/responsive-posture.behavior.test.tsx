 ...
 * `patterns/runtime/adaptive-layout/runtime/tests/solver.test.ts` — they belong
 * to geometry, not to React, and therefore live with the shared solver rather
 * than with this board.
 */
...
import {
  ...
  useContainerPosture,
} from '../../../../../../runtime/adaptive-layout/presentation/react';
