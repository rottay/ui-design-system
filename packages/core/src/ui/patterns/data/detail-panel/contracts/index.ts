...
import type { DetailPanelSidebarPosition } from '@/foundation/contracts/runtime/components/patterns/data';

export type { DetailPanelSidebarPosition } from '@/foundation/contracts/runtime/components/patterns/data';
