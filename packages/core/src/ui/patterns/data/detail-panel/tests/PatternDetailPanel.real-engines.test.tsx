...
const SKINS: Record<'modern' | 'rustic', string> = {
  modern: readFileSync(
    join(here, '../../../../../foundation/tokens/css/runtime/engines/modern/skin/detail-panel.css'),
    'utf8',
  ),
  rustic: readFileSync(
    join(here, '../../../../../foundation/tokens/css/runtime/engines/rustic/skin/detail-panel.css'),
    'utf8',
  ),
};
