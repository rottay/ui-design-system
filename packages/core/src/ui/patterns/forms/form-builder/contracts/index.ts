...
import type { PatternBaseProps, FieldDef } from '../../../../../foundation/contracts/runtime/components/patterns/core';
import type {
  FormBuilderLayout,
  FormBuilderRenderField,
} from '@/foundation/contracts/runtime/components/patterns/forms';
