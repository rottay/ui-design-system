...
import type { StepWizardOrientation } from '@/foundation/contracts/runtime/components/patterns/forms';

export type { StepWizardOrientation } from '@/foundation/contracts/runtime/components/patterns/forms';
...
export interface StepWizardProps extends PatternBaseProps {
   ...
   * `sticky-bottom` composes StepWizard-owned fixed action chrome and reserves content
