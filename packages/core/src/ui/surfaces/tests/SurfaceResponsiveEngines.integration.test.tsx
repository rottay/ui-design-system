...
import { DetailSurface } from '../presentation/pages/data/detail';
import { FormSurface } from '../presentation/pages/forms/form';
import { ListSurface } from '../presentation/pages/data/list';
import { MarketingSurface } from '../presentation/pages/experience/marketing';
import { OperationalSurface } from '../presentation/pages/operations/operational';
import type {
  AuthSurfaceConfig,
  DetailSurfaceConfig,
  EntityAdapter,
