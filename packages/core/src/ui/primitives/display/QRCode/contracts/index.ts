/**
 * @fileoverview QRCode Types - Rottay Design System
 * @description Type definitions for QRCode component.
 *
 * @remarks
 * This module provides QRCode types and configuration constants.
 *
...
import type { BaseComponentProps, BorderedProps } from '../../../../../foundation/contracts/kernel/common';
