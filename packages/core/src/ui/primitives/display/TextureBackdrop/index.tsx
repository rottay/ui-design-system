 ...
 * halftone) on an `aria-hidden` layer positioned behind `children`, so large flat monochrome
 * zones get life without ever introducing hue. The layer paints in `currentColor`, resolved from
 * `--ds-texture-backdrop-ink` by default and switched to `--ds-texture-backdrop-paper`
