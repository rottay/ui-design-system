...
export type { AvatarProps, AvatarSize, AvatarShape, AvatarStatus, AvatarVariant, AvatarTone } from './contracts';
export { AVATAR_DEFAULTS, TONE_TO_AVATAR_VARIANT } from './contracts';
