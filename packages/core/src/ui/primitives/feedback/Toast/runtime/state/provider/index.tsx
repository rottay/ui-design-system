 ...
 * Exposes imperative methods via context while Toast paint and keyframes come
 * from the required public stylesheet.
 *
 * @example
 * ```tsx
...
import type { ToastState, ToastOptions, ToastMethods, ToastProviderConfig } from '../../../contracts';
import { TOAST_DEFAULTS, TOAST_CONTAINER_DEFAULTS } from '../../../contracts';
import { clearToastMethods, setToastMethods } from '../method-registry';
