...
/**
 * @fileoverview Tour Classic Engine - Rottay Design System
 * @description Classic (Ant Design) implementation of the Tour component.
 ...
 * @module Tour/Engines/Classic
 * @category Overlay
 * @package @rottay/design-system
 */
import React from 'react';
import { Tour as AntTour } from 'antd';
import type { TourProps } from '../../contracts';

/**
 * Classic engine implementation of Tour using Ant Design.
 *
 * Features:
 ...
 * @example
 * ```tsx
 * <Tour steps={steps} open={isOpen} engine="classic" />
 * ```
 *
