...
vi.mock('../../../runtime/overlay/portal', () => ({
...
describe('Modal Types', () => {
  it('exports MODAL_DEFAULTS constant', async () => {
    const { MODAL_DEFAULTS } = await import('../contracts');
  ...
  it('exports SIZE_MAP constant', async () => {
    const { SIZE_MAP } = await import('../contracts');
  ...
  it('exports PADDING_MAP constant', async () => {
    const { PADDING_MAP } = await import('../contracts');
