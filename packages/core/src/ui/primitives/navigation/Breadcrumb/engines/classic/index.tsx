/**
 * @fileoverview Breadcrumb Classic Engine - Rottay Design System
 ...
 * Classic breadcrumbs inherit Ant Design's theme tokens which can be
 ...
 * @module Breadcrumb/Engines/Classic
 * @category Navigation
...
import { BREADCRUMB_DEFAULTS } from '../../contracts';
...
/**
 * Classic Engine implementation of the Breadcrumb component.
 *
 * @description
 ...
 * ```
 */
export default function ClassicBreadcrumb(props: BreadcrumbProps): React.ReactElement {
  // ---------------------------------------------------------------------------
  // Props Destructuring
  // ---------------------------------------------------------------------------
