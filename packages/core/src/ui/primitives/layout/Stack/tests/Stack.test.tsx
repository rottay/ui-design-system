...
describe("Stack", () => {
  ...
  describe('Polymorphic "as" Prop', () => {
    it('renders as span when as="span"', () => {
      render(
        <Stack as="span" data-testid="span-stack">
          Content
        </Stack>
      );
    ...
    it('renders as article when as="article"', () => {
      render(
        <Stack as="article" data-testid="article-stack">
          Content
        </Stack>
      );
    ...
    it('renders as nav when as="nav"', () => {
      render(
        <Stack as="nav" data-testid="nav-stack">
          Content
        </Stack>
      );
    ...
    it('renders as ul when as="ul"', () => {
      render(
        <Stack as="ul" data-testid="ul-stack">
          <li>Item</li>
        </Stack>
      );
    ...
    it('renders as ol when as="ol"', () => {
      render(
        <Stack as="ol" data-testid="ol-stack">
          <li>Item</li>
        </Stack>
      );
  ...
  describe("Spacing/Gap Props", () => {
    it.each([
      ...
      "3xl",
      "4xl",
    ] as const)("applies spacing %s", (spacing) => {
  ...
  describe("className and style Props", () => {
    ...
    it("applies inline styles", () => {
      render(
        <Stack style={{ backgroundColor: "red", padding: "10px" }}>Test</Stack>
      );
      const stack = screen.getByTestId("stack");
  ...
  describe("Accessibility", () => {
    ...
    it("supports role attribute", () => {
      render(
        <Stack role="list" data-testid="list-stack">
          Test
        </Stack>
      );
  ...
  describe("Event Handlers", () => {
    ...
    it("handles onMouseEnter event", async () => {
      ...
      const { container } = render(
        <Stack onMouseEnter={handleMouseEnter}>Hover me</Stack>
      );
    ...
    it("handles onMouseLeave event", async () => {
      ...
      const { container } = render(
        <Stack onMouseLeave={handleMouseLeave}>Leave me</Stack>
      );
      const stack = container.firstChild as HTMLElement;
      const { fireEvent } = await import("@testing-library/react");
...
describe("Stack Types and Constants", () => {
  it("exports STACK_DEFAULTS constant", async () => {
    const { STACK_DEFAULTS } = await import("../contracts");
  ...
  it("exports SPACING_MAP constant", async () => {
    const { SPACING_MAP } = await import("../contracts");
  ...
  it("exports ALIGN_MAP constant", async () => {
    const { ALIGN_MAP } = await import("../contracts");
  ...
  it("exports JUSTIFY_MAP constant", async () => {
    const { JUSTIFY_MAP } = await import("../contracts");
  ...
  it("exports resolveSpacing function", async () => {
    const { resolveSpacing } = await import("../contracts");
