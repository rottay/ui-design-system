...
export const TextPositions: Story = {
  ...
  render: () => (
    <div style={{ padding: "20px" }}>
      <Divider textPosition="start">Logical Start</Divider>
      <p>Some content...</p>
      <Divider textPosition="center">Center Aligned (default)</Divider>
      <p>Some content...</p>
      <Divider textPosition="end">Logical End</Divider>
    </div>
  ),
};
...
/** Text craft and line weight remain tenant-tokenized with identical markup. */
export const TokenizedLocalizedLabels: Story = {
  name: "Modern contract — tokenized localized labels",
  render: () => (
    <div style={{ display: "grid", gap: "var(--ds-spacing-4)" }}>
      <section
        style={
          {
            "--ds-divider-thickness-thin": "1px",
            "--ds-divider-label-transform": "uppercase",
            "--ds-divider-label-tracking": "var(--ds-letter-spacing-wider)",
          } as React.CSSProperties
        }
      >
        <Divider engine="modern">Decision evidence</Divider>
      </section>
      <section
        dir="rtl"
        lang="ar"
        style={
          {
            "--ds-divider-thickness-thin": "2px",
            "--ds-divider-label-transform": "none",
            "--ds-divider-label-tracking": "normal",
          } as React.CSSProperties
        }
      >
        <Divider engine="modern" textPosition="start">
          أدلة القرار
        </Divider>
      </section>
    </div>
...
export const CompareEngines: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Compare the same Divider rendered by Classic (Ant Design), Modern (DaisyUI), and Rustic (Vanilla CSS).",
      },
    },
  },
  render: () => (
...
export const Accessibility: Story = {
  ...
  render: () => (
    <div style={{ padding: "20px" }}>
      <p>The Divider component includes proper accessibility attributes:</p>
      <ul style={{ marginBottom: "16px" }}>
        <li>
          <code>role="separator"</code> - Indicates the element is a separator
        </li>
        <li>
          <code>aria-orientation</code> - Indicates horizontal or vertical
          orientation
        </li>
        <li>
          Lines are marked with <code>aria-hidden="true"</code> when text is
          present
        </li>
      </ul>
...
export const TypeAlias: Story = {
  ...
  render: () => (
    <div style={{ padding: "20px" }}>
      <p>
        Using <code>type</code> prop as alias for <code>orientation</code>:
      </p>
  ...
  render: () => (
    <div style={{ padding: "20px" }}>
      <p style={{ fontSize: "14px", color: "#666", marginBottom: "16px" }}>
        Dividers automatically adapt to container width. Vertical dividers adapt
        to container height.
      </p>
      <div style={{ width: "100%" }}>
