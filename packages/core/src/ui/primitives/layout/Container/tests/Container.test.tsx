...
describe("Container", () => {
  ...
  describe("Fluid Prop", () => {
    it("is not fluid by default", () => {
      render(<Container>Test</Container>);
      expect(screen.getByTestId("container")).not.toHaveAttribute(
        "data-fluid",
        "true"
      );
    });
  ...
  describe("Accessibility", () => {
    ...
    it("supports role attribute", () => {
      render(
        <Container role="main" data-testid="main-container">
          Test
        </Container>
      );
...
describe("Container Types", () => {
  ...
  it("exports CONTAINER_DEFAULTS constant", async () => {
    const { CONTAINER_DEFAULTS } = await import("../contracts");
  ...
  it("exports CONTAINER_MAX_WIDTHS constant", async () => {
    const { CONTAINER_MAX_WIDTHS } = await import("../contracts");
  ...
  it("exports CONTAINER_PADDINGS constant", async () => {
    const { CONTAINER_PADDINGS } = await import("../contracts");
