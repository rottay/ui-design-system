...
describe("Box", () => {
  ...
  describe('Polymorphic "as" Prop', () => {
    it('renders as span when as="span"', () => {
      render(
        <Box as="span" data-testid="span-box">
          Content
        </Box>
      );
    ...
    it('renders as article when as="article"', () => {
      render(
        <Box as="article" data-testid="article-box">
          Content
        </Box>
      );
    ...
    it('renders as aside when as="aside"', () => {
      render(
        <Box as="aside" data-testid="aside-box">
          Content
        </Box>
      );
    ...
    it('renders as main when as="main"', () => {
      render(
        <Box as="main" data-testid="main-box">
          Content
        </Box>
      );
    ...
    it('renders as header when as="header"', () => {
      render(
        <Box as="header" data-testid="header-box">
          Content
        </Box>
      );
    ...
    it('renders as footer when as="footer"', () => {
      render(
        <Box as="footer" data-testid="footer-box">
          Content
        </Box>
      );
    ...
    it('renders as nav when as="nav"', () => {
      render(
        <Box as="nav" data-testid="nav-box">
          Content
        </Box>
      );
  ...
  describe("Display Props", () => {
    it.each([
      ...
      "grid",
      "none",
    ] as const)("applies display %s", (display) => {
  ...
  describe("Accessibility", () => {
    ...
    it("supports role attribute", () => {
      render(
        <Box role="region" data-testid="region-box">
          Test
        </Box>
      );
  ...
  describe("Combined Props", () => {
    ...
    it("combines shorthand and regular props correctly", () => {
      render(
        <Box p="sm" m="md" w="100%" h="auto" bg="white" rounded="md">
          Shorthand Box
        </Box>
      );
      const box = screen.getByTestId("box");
  ...
  describe("Event Handlers", () => {
    ...
    it("handles onMouseEnter event", async () => {
      ...
      const { container } = render(
        <Box onMouseEnter={handleMouseEnter}>Hover me</Box>
      );
    ...
    it("handles onMouseLeave event", async () => {
      ...
      const { container } = render(
        <Box onMouseLeave={handleMouseLeave}>Leave me</Box>
      );
      const box = container.firstChild as HTMLElement;
      const { fireEvent } = await import("@testing-library/react");
...
describe("Box Types", () => {
  ...
  it("exports BOX_DEFAULTS constant", async () => {
    const { BOX_DEFAULTS } = await import("../contracts");
  ...
  it("exports RADIUS_MAP constant", async () => {
    const { RADIUS_MAP } = await import("../contracts");
