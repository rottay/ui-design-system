import type { InvertSectionProps } from './contracts';
 ...
 * `--ds-surface-bg`, text from `--ds-surface-fg` — both reassigned locally from the
 * `surface` prop, mirroring the same ink/paper token pairing `foundation/tokens/css/foundation/monochrome/index.css` defines once
 * for `.ds-mono-surface[data-surface="paper"]`, so an `InvertSection` is a self-contained
