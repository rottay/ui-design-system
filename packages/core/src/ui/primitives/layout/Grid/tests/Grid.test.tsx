...
vi.mock(
  "@/infrastructure/runtime/engines/presentation/component-factory",
  () => {
...
describe("Grid", () => {
  ...
  describe('Polymorphic "as" Prop', () => {
    it('renders as section when as="section"', () => {
      render(
        <Grid as="section" data-testid="section-grid">
          Content
        </Grid>
      );
    ...
    it('renders as ul when as="ul"', () => {
      render(
        <Grid as="ul" data-testid="ul-grid">
          Content
        </Grid>
      );
    ...
    it('renders as nav when as="nav"', () => {
      render(
        <Grid as="nav" data-testid="nav-grid">
          Content
        </Grid>
      );
    ...
    it('renders as main when as="main"', () => {
      render(
        <Grid as="main" data-testid="main-grid">
          Content
        </Grid>
      );
  ...
  describe("Columns Prop", () => {
    it.each([1, 2, 3, 4, 6, 12] as const)("applies columns %s", (columns) => {
  ...
  describe("Alignment Props", () => {
    ...
    it.each([
      ...
      "space-around",
      "space-evenly",
    ] as const)("applies alignContent %s", (alignContent) => {
    ...
    it.each([
      ...
      "space-around",
      "space-evenly",
    ] as const)("applies justifyContent %s", (justifyContent) => {
...
describe("Grid.Item", () => {
  ...
  describe("Spanning Props", () => {
    it("applies span prop as gridColumn style", () => {
      render(
        <GridItem data-testid="item" span={2}>
          Content
        </GridItem>
      );
  ...
  describe("Positioning Props", () => {
    it("applies colStart and colEnd as gridColumn style", () => {
      render(
        <GridItem data-testid="item" colStart={1} colEnd={3}>
          Content
        </GridItem>
      );
    ...
    it("applies rowStart and rowEnd as gridRow style", () => {
      render(
        <GridItem data-testid="item" rowStart={2} rowEnd={4}>
          Content
        </GridItem>
      );
    ...
    it("applies area prop as gridArea style", () => {
      render(
        <GridItem data-testid="item" area="header">
          Content
        </GridItem>
      );
  ...
  describe("Self Alignment Props", () => {
    it.each(["start", "end", "center", "stretch", "baseline"] as const)(
      ...
      (alignSelf) => {
        render(
          <GridItem data-testid="item" alignSelf={alignSelf}>
            Content
          </GridItem>
        );
    ...
    it.each(["start", "end", "center", "stretch"] as const)(
      ...
      (justifySelf) => {
        render(
          <GridItem data-testid="item" justifySelf={justifySelf}>
            Content
          </GridItem>
        );
        const item = screen.getByTestId("item");
    ...
    it.each(["start", "end", "center", "stretch"] as const)(
      ...
      (placeSelf) => {
        render(
          <GridItem data-testid="item" placeSelf={placeSelf}>
            Content
          </GridItem>
        );
        const item = screen.getByTestId("item");
  ...
  describe("Z-Index Prop", () => {
    it("applies zIndex as style", () => {
      render(
        <GridItem data-testid="item" zIndex={10}>
          Content
        </GridItem>
      );
      const item = screen.getByTestId("item");
  ...
  describe('Polymorphic "as" Prop', () => {
    it('renders as li when as="li"', () => {
      render(
        <GridItem as="li" data-testid="li-item">
          Content
        </GridItem>
      );
    ...
    it('renders as article when as="article"', () => {
      render(
        <GridItem as="article" data-testid="article-item">
          Content
        </GridItem>
      );
...
describe("Grid Types", () => {
  it("exports GRID_DEFAULTS constant", async () => {
    const { GRID_DEFAULTS } = await import("../contracts");
  ...
  it("exports ALIGN_ITEMS_MAP constant", async () => {
    const { ALIGN_ITEMS_MAP } = await import("../contracts");
  ...
  it("exports JUSTIFY_ITEMS_MAP constant", async () => {
    const { JUSTIFY_ITEMS_MAP } = await import("../contracts");
...
describe("Grid tenants", () => {
  it.each(["rottay", "bithire", "default"] as const)(
    "renders with %s tenant",
    (tenant) => {
