...
const meta: Meta<typeof Space> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Space component for adding consistent spacing between elements with multi-engine support.",
      },
    },
  },
  argTypes: {
...
/** Logical direction, wrap resilience, and decorative split semantics. */
export const LocalizedResponsiveGroup: Story = {
  name: "Modern contract — RTL, wrap, and overflow",
  render: () => (
    <div style={{ inlineSize: "min(100%, 32rem)" }}>
      <Space
        engine="modern"
        role="group"
        aria-label="פעולות מועמד"
        lang="he"
        dir="rtl"
        wrap
        size={[8, 12]}
...
export const CompareEngines: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Compare the same Space rendered by Classic (Ant Design), Modern (DaisyUI), and Rustic (Vanilla CSS).",
      },
    },
  },
  render: () => (
