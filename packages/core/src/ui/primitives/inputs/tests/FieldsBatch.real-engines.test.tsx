...
const SKINS: Record<string, string> = {
  'modern/form-field': read('runtime/engines/modern/skin/form-field.css'),
  'rustic/form-field': read('runtime/engines/rustic/skin/form-field.css'),
  'modern/textarea': read('runtime/engines/modern/skin/textarea.css'),
  'rustic/textarea': read('runtime/engines/rustic/skin/textarea.css'),
  'modern/tag-input': read('runtime/engines/modern/skin/tag-input.css'),
  'rustic/tag-input': read('runtime/engines/rustic/skin/tag-input.css'),
  'modern/input-number': read('runtime/engines/modern/skin/input-number.css'),
  'rustic/input-number': read('runtime/engines/rustic/skin/input-number.css'),
  'modern/password-input': read('runtime/engines/modern/skin/password-input.css'),
  'rustic/password-input': read('runtime/engines/rustic/skin/password-input.css'),
  'modern/switch': read('runtime/engines/modern/skin/switch.css'),
  'rustic/switch': read('runtime/engines/rustic/skin/switch.css'),
  'modern/toggle': read('runtime/engines/modern/skin/toggle.css'),
  'rustic/toggle': read('runtime/engines/rustic/skin/toggle.css'),
  'modern/radio': read('runtime/engines/modern/skin/radio.css'),
  'rustic/radio': read('runtime/engines/rustic/skin/radio.css'),
  'modern/checkbox': read('runtime/engines/modern/skin/checkbox.css'),
  'rustic/checkbox': read('runtime/engines/rustic/skin/checkbox.css'),
  'modern/slider': read('runtime/engines/modern/skin/slider.css'),
  'rustic/slider': read('runtime/engines/rustic/skin/slider.css'),
  'modern/otp-input': read('runtime/engines/modern/skin/otp-input.css'),
  ...
  'button-icon': read('presentation/components/skin/button-icon.css'),
  'voice-input-button': read('presentation/components/skin/voice-input-button.css'),
  'input-compounds': read('presentation/components/skin/input-compounds.css'),
};
