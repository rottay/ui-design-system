 ...
 * BrandTheme/generated chrome CSS (compilers/brand-theme/index.ts) can
...
import { resolvePersonalityCssVariables } from '../primitives';
import { DEFAULT_PERSONALITY } from '../defaults';
import type { DesignTokens, PersonalityTokens } from '../../../contracts';
...
// chrome CSS (compilers/brand-theme) are marked -- those are exactly the
...
const EXPECTED_KEYS = [
  ...
  '--ds-card-shadow', // tenant-declarable: chrome.cardComponent.shadow (compilers/brand-theme/index.ts:815)
