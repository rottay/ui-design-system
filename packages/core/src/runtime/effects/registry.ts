...
import { isEffectDefinition } from './validation';
...
const DEFINITIONS = [
  {
    ...
    provenance: sourceProvenance('packages/core/src/motion/effects/aurora/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    provenance: sourceProvenance('packages/core/src/motion/effects/glass-card/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    provenance: sourceProvenance('packages/core/src/motion/effects/glow-effect/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    purpose: 'ambient',
    observed: { renderer: 'motion', loop: 'while-live', lazy: false },
    provenance: sourceProvenance('packages/core/src/motion/effects/gradient-background/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    provenance: sourceProvenance('packages/core/src/motion/effects/grid-pattern/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    provenance: sourceProvenance('packages/core/src/motion/primitives/magnetic/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    provenance: sourceProvenance('packages/core/src/motion/effects/noise-texture/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    purpose: 'hierarchy',
    observed: { renderer: 'motion', loop: 'none', lazy: false },
    provenance: sourceProvenance('packages/core/src/motion/primitives/parallax/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    provenance: sourceProvenance('packages/core/src/motion/effects/particles/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    purpose: 'state',
    observed: { renderer: 'css', loop: 'while-live', lazy: false },
    provenance: sourceProvenance('packages/core/src/motion/effects/shimmer-text/index.tsx'),
    fallback: {
  ...
  },
  {
    ...
    purpose: 'feedback',
    observed: { renderer: 'css', loop: 'none', lazy: false },
    provenance: sourceProvenance('packages/core/src/motion/effects/spotlight/index.tsx'),
    fallback: {
