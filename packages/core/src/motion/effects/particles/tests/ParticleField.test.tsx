...
vi.mock('../../../../runtime/motion', () => ({
  useMotionPolicy: () => motion.policy,
}));

import { ParticleField } from '../index';
import { ParticleFieldLoadingFallback } from '../public';
import {
  PARTICLE_RUNTIME_LIMITS,
  resetParticleAnimationLeaseForTests,
} from '../runtime';
import { installInheritedCustomPropertyModel } from './inherited-custom-properties';
...
describe('ParticleField loading facade', () => {
