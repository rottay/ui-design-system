 ...
 *
 * This module is loaded only through the public lazy facade. Canvas work is
...
import { PROVIDER_PAINT_ATTRIBUTE_FILTER } from '@/_internal/color/css/resolve-css-color';
import type { ParticleFieldFocalArea, ParticleFieldProps } from '../../types';
import { useMotionPolicy } from '../../../runtime/motion';
import { isParticleAnimationEligible } from './eligibility';
import {
...
import { useParticleInView } from './use-particle-in-view';
...
/** Canvas implementation; the public facade retains the lazy boundary. */
