...
import { PhosphorSsrIconAdapter } from '../adapters/phosphor-ssr';
import { getIconCorpusEntry, isIconName } from './registry';
import { resolveIconTone, resolveIconWeight } from './presentation';
import type { IconMirroring, IconProps, IconRole, IconState, IconTone } from './types';
