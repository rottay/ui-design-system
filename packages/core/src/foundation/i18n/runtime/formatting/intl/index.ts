...
function reportFormattingError(message: string, error: unknown): void {
...
export function formatDate(
  ...
  try {
    ...
    reportFormattingError('Error formatting date:', error);
...
export function formatNumber(
  ...
  try {
    ...
    reportFormattingError('Error formatting number:', error);
...
export function formatCurrency(
  ...
  try {
    ...
    reportFormattingError('Error formatting currency:', error);
...
export function formatRelativeTime(
  ...
  try {
    ...
    reportFormattingError('Error formatting relative time:', error);
...
export function formatPercent(
  ...
  try {
    ...
    reportFormattingError('Error formatting percent:', error);
...
export function formatDateRange(
  ...
  try {
    ...
    reportFormattingError('Error formatting date range:', error);
...
export function formatList(
  ...
  try {
    ...
    reportFormattingError('Error formatting list:', error);
    return items.join(', ');
  }
}
