/**
 * @fileoverview The Evnto vertical theme preset source of WO-DER-06: a v2
 ...
 * cast here.
 *
 * @module Foundation/Presets/Verticals/Evnto
 * @category Types
...
export const EVNTO_PRESET_SOURCE: { readonly document: unknown; readonly manifest: unknown } =
