/**
 * @fileoverview The BitHire vertical theme preset source of WO-DER-06: a v2
 ...
 * cast here.
 *
 * @module Foundation/Presets/Verticals/BitHire
 * @category Types
...
export const BITHIRE_PRESET_SOURCE: { readonly document: unknown; readonly manifest: unknown } =
