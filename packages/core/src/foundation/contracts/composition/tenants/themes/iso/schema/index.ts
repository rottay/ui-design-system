...
export const THEME_LEAF_OPTIONS: Readonly<Record<string, readonly string[]>> =
  ...
  "surfaces.borderStyle": Object.freeze(["hairline", "none", "strong"]),
  "surfaces.buttonStyle": Object.freeze(["pill", "sharp", "soft"]),
  "surfaces.controlHeight": Object.freeze(["compact", "standard", "tall"]),
  ...
  "surfaces.nesting": Object.freeze(["concentric", "uniform"]),
  ...
  "typography.numeric": Object.freeze(["proportional", "tabular"]),
  "typography.roleWeights": Object.freeze(["light", "regular", "strong"]),
