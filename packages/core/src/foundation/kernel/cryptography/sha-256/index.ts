/**
 * @fileoverview Portable SHA-256 (UTF-8) with no platform dependency.
 *
 * Runs in Node SSR, Edge/middleware and the browser hydration boundary without
 * importing `node:crypto` or any other host-specific module. The implementation
 * is intentionally self-contained and side-effect free.
 */
