 ...
 *
 * @module Foundation/Kernel/Accessibility/BrandingContrast
...
import {
  ...
  contrastRatio,
  isHexColor,
  linearizeSrgbChannel as linearize,
  parseHex,
  relativeLuminance,
} from '../../color/contrast';
...
// ---------------------------------------------------------------------------
// Internal: hex helpers. Parsing and the WCAG transfer function live in the
// scalar colorimetry owner (foundation/kernel/color/contrast).
// ---------------------------------------------------------------------------
...
/**
 * Contrast ratio between two colors (1:1 to 21:1), defined in the scalar
 * colorimetry owner (foundation/kernel/color/contrast). Re-exported because
 * this module's established importers resolve it from this path.
 */
 ...
 * dependency (used by `scripts/check/engine/tokens/audit/index.mjs`), not a dependency of
