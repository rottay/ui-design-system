 ...
 *
 * Authority:
 *   • C1: Fable 5 + Kimi K3 census in /private/tmp/modern-rescue-extension-fable.txt
 *     (zero-read + app-only + reduced-motion + shadowed duplicates).
 *   • C2: K3 C2_ACCEPT + Fable C2_EXACT_ACCEPT in /private/tmp/C2-MASSIVE-RULING.md
...
describe("exact-name deletion does not harm near-name siblings", () => {
  ...
  it("evnto keeps both button-hover homonyms on the compiled dark surface", () => {
    ...
    // evnto-t2-final-drain.test.ts and in the compiled block below.
