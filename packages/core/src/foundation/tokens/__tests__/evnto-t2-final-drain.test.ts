/**
 * EVNTO TERMINAL-2 — final extension drain (custom 0/0/0).
 *
 * Authority: Fable 5 PREACCEPT
 * (/private/tmp/evnto-terminal2-preaudit-fable.txt) and Kimi K3 PREACCEPT
 * (/private/tmp/evnto-terminal2-preaudit-kimi.txt), both ACCEPT / HOLD 0.
 *
...
const INPUT_SKIN_PATH = join(
  ROOT,
  "src/foundation/tokens/css/runtime/engines/modern/skin/input.css"
);
