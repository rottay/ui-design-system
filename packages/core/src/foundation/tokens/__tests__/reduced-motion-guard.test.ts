...
const ROSTER = [
  ...
  "presentation/components/skin/record-facts.css",
...
const HEADER_HERO_MOTION_OWNERS = [
  {
    path: "presentation/components/skin/header-hero-shared.css",
    selectors: [
  ...
  {
    path: "presentation/components/skin/edit-header.css",
    selectors: [".ds-structure.ds-edit-header[data-part='root']"],
  },
  {
    path: "presentation/components/skin/form-header.css",
...
const RECORD_FACTS_MOTION_OWNER = "presentation/components/skin/record-facts.css";
const RECORD_FACTS_MODERN_SKIN = "runtime/engines/modern/skin/record-facts.css";
