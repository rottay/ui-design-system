 ...
 * the four probe fixtures moved to `tests/fixtures/brand-themes`
...
describe('brand-themes tree pins vertical ownership', () => {
  ...
  it('probe fixtures live under tests, never in the production tree', () => {
