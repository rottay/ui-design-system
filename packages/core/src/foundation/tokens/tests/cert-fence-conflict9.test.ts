 ...
 *     Verified read-only from governance/tokens/decisions/writers/unused/system/index.json: executed:true,
...
const LEDGER_PATH = join(ROOT, "governance/tokens/decisions/writers/unused/system/index.json");
...
function assertSightedPendingB6(candidate: typeof ledger): void {
  ...
  assertSightedPendingB6Sources(entries, {
    defaultCss: readCss("css/foundation/themes/default/index.css"),
    inputCss: readCss("css/presentation/components/input/index.css"),
    modernInputCss: readCss("css/runtime/engines/modern/skin/input/index.css"),
    frameworkBridgeCss: readCss("css/runtime/engines/modern/framework-bridge/index.css"),
    terminalCss: readCss("css/presentation/components/skin/data-terminal-card/index.css"),
    exportButtonCss: readCss("css/presentation/components/skin/export-button/index.css"),
    chartCss: readCss("css/presentation/components/skin/chart-foundation/index.css"),
  });
}
...
// `scripts/check/verticals/single-author/index.mjs` law G2, which is strictly
...
describe("CERT-FENCE-CONFLICT9 mutants turn red", () => {
  ...
  // `scripts/check/verticals/single-author/index.mjs`, whose drills include a
