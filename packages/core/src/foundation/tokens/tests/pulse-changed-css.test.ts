 ...
 * pulse are pure CSS (`foundation/animations/transitions/index.css`), so they
...
const TRANSITIONS_CSS_PATH = resolve(TEST_DIR, '..', 'css/foundation/animations/transitions/index.css');
