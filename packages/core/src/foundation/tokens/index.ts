 ...
 *
 * - **CSS custom properties** (`foundation/tokens/css/`) -- consumed by stylesheets and
 ...
 *
 * - **TypeScript mirrors** (`foundation/tokens/ts/`) -- provide type-safe references to
