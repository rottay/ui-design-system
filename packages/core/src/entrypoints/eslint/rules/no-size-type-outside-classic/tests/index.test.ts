...
function visitors(filename = "/repo/packages/core/src/components/primitives/inputs/switch/contracts/index.ts") {
...
describe("no-size-type-outside-classic", () => {
  ...
  it("exempts engines/classic/ paths -- the antd size-vocabulary bridge", () => {
    const { created } = visitors(
      "/repo/packages/core/src/components/primitives/inputs/switch/engines/classic/index.tsx",
    );
  ...
  it("respects a user-supplied exempt glob", () => {
    const created = noSizeTypeOutsideClassic.create({
      filename: "/repo/packages/core/src/components/primitives/inputs/switch/legacy-bridge/index.ts",
