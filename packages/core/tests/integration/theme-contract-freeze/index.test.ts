...
describe("channel minting and CSS text have declared owners", () => {
  ...
  it("every channel minted under the pipeline belongs to a declared lowering owner", () => {
    ...
    expect(minting.sort()).toEqual([
      ...
      `${LOWERING_ROOT}/foundation/ramps/index.ts`,
      `${LOWERING_ROOT}/foundation/type-ramp/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/charts/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/active-filters-bar/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/alert-dialog/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/alert/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/aspect-ratio/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/auto-complete/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/avatar/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/badge/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/box/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/breadcrumb/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/button/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/calendar-view/index.ts`,
      ...
      `${LOWERING_ROOT}/runtime/derivation/chrome/cockpit-header/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/collapse/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/collection-header/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/color-picker/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/column-menu/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/column-settings/index.ts`,
      ...
      `${LOWERING_ROOT}/runtime/derivation/chrome/dashboard-header/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/data-table/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/date-picker/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/descriptions/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/detail-form-surface/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/detail-header/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/divider/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/drawer/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/dropdown/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/edit-header/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/file-manager/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/filter-chip/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/filter-panel/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/flex/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/form-field/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/form-header/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/form-sections/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/form-surface/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/form/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/grid/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/guided-draft-form/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/header/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/hover-card/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/input-number/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/input/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/kanban-board/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/list/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/mentions/index.ts`,
      ...
      `${LOWERING_ROOT}/runtime/derivation/chrome/pagination/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/password-input/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/popover/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/radio/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/record/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/saved-views/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/section-frame/index.ts`,
      ...
      `${LOWERING_ROOT}/runtime/derivation/chrome/space/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/splitter/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/stack/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/stats-header/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/stepper/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/surface-lifecycle/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/table/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/tabs/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/tag-input/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/tag/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/textarea/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/time-picker/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/toggle/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/toolbar/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/tooltip/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/tour/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/transfer/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/tree-select/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/tree/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/widget-board/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/wizard-surface/index.ts`,
      `${LOWERING_ROOT}/runtime/derivation/chrome/workbench-header/index.ts`,
      ...
      `${LOWERING_ROOT}/runtime/derivation/typography/tier/index.ts`,
