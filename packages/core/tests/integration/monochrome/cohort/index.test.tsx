/**
 * Monochrome cohort contract tests (WO-SHW-01 acceptance gate).
 *
 * Verifies the three laws the whole cohort must uphold: every component renders; decorative
...
import { MonoStat } from '../../../../src/components/patterns/data/mono-stat';
import { TerminalBlock } from '../../../../src/components/patterns/feedback/terminal-block';
import { AsciiDiagram } from '../../../../src/components/patterns/visualization/ascii-diagram';
import { TreeViewConnector } from '../../../../src/components/patterns/visualization/tree-view/presentation/connector';
import { CropMarks, TextureBackdrop, Typewriter } from '../../../../src/components/primitives/display';
...
describe("monochrome cohort — every component renders", () => {
  it("renders all 11 components without throwing", () => {
    const { container } = render(
      <div>
        ...
        <TreeViewConnector data={{ label: "root", children: [{ label: "leaf" }] }} />
...
describe("monochrome cohort — ASCII is never the sole information carrier", () => {
...
describe("monochrome cohort — reveals collapse under reduced motion", () => {
