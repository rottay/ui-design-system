...
const SERVER_SOURCE_PATHS = [
  ...
  "src/graphics/marks/runtime/adapters/thesvg-react/index.ts",
  "src/graphics/marks/runtime/adapters/thesvg-react/brand/index.tsx",
  "src/graphics/marks/runtime/adapters/thesvg-react/cloud-service/index.tsx",
  "src/graphics/pictograms/presentation/feature-pictogram/index.tsx",
] as const;

const CSS_BY_ASSET_CLASS = {
  "semantic-icon":
    "src/foundation/tokens/css/presentation/components/semantic-icon/index.css",
  "brand-mark": "src/foundation/tokens/css/presentation/components/mark/index.css",
  "cloud-service-mark":
    "src/foundation/tokens/css/presentation/components/mark/index.css",
  "feature-pictogram":
...
describe("CRA17 four-facade asset certification", () => {
  ...
  it("ships explicit forced-colors behavior for all four classes through every CSS facade", () => {
    ...
    for (const entrypoint of cssEntrypoints) {
      expect(entrypoint).toContain("semantic-icon/index.css");
      expect(entrypoint).toContain("mark/index.css");
      expect(entrypoint).toContain("feature-pictogram/index.css");
    }
  });
});
