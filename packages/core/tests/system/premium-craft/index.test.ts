...
const FLAGSHIP_SKINS = [
  ['Button', 'foundation/tokens/css/runtime/engines/modern/skin/button/index.css'],
  ['Card', 'foundation/tokens/css/runtime/engines/modern/skin/card/index.css'],
  ['Typography', 'foundation/tokens/css/runtime/engines/modern/skin/typography/index.css'],
  ['Tabs', 'foundation/tokens/css/runtime/engines/modern/skin/tabs/index.css'],
  ['Tooltip', 'foundation/tokens/css/runtime/engines/modern/skin/tooltip/index.css'],
  ['Popover', 'foundation/tokens/css/runtime/engines/modern/skin/popover/index.css'],
  ['DataTable', 'foundation/tokens/css/runtime/engines/modern/skin/data-table/index.css'],
  [
    'DecisionComparison',
    'foundation/tokens/css/presentation/components/skin/decision-comparison/index.css',
  ],
] as const;
