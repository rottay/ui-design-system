...
import { STABLE_ENGINES, renderWithEngine } from '../../support/engine';

describe('engine gap smoke coverage', () => {
  it.each(STABLE_ENGINES)('renders Calendar through the %s engine', async (engine) => {
    if (engine === 'classic') {
      await import('../../../src/components/primitives/display/calendar/engines/classic');
    } else if (engine === 'modern') {
      await import('../../../src/components/primitives/display/calendar/engines/modern');
    } else {
      await import('../../../src/components/primitives/display/calendar/engines/rustic');
    }
  ...
  it.each(STABLE_ENGINES)('renders Tour through the %s engine', async (engine) => {
    if (engine === 'classic') {
      await import('../../../src/components/primitives/overlay/tour/engines/classic');
    } else if (engine === 'modern') {
      await import('../../../src/components/primitives/overlay/tour/engines/modern');
    } else {
      await import('../../../src/components/primitives/overlay/tour/engines/rustic');
    }
