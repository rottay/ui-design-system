...
import * as componentsEntry from '../../../src/components';
import * as iconsEntry from '@/graphics/icons';
import * as i18nEntry from '@/infrastructure/runtime/i18n';

const engineBarrels = import.meta.glob(
  [
    '../../../src/components/**/engines/classic.tsx',
    '../../../src/components/**/engines/classic/index.tsx',
  ],
  { eager: true },
) as Record<string, Record<string, unknown>>;

const compoundBarrels = import.meta.glob('../../../src/components/**/compound/**/index.ts', {
  eager: true,
}) as Record<string, Record<string, unknown>>;
