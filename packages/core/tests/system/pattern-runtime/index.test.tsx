...
describe('pattern smoke coverage', () => {
  beforeAll(async () => {
    await Promise.all([
      import('../../../src/components/patterns/data/detail-panel/engines/classic'),
      import('../../../src/components/patterns/data/detail-panel/engines/modern'),
      import('../../../src/components/patterns/data/detail-panel/engines/rustic'),
    ]);
  });
