...
> (or a per-vertical bundle like `@rottay/design-system/styles/rottay`).
...
@import "@rottay/design-system/styles/rottay"; /* Rottay */
...
#### Colors (`css/foundation/themes/default/index.css` + generated `css/facade/artifacts/*/index.css`)
...
#### Spacing (`css/foundation/base/spacing/index.css`)
...
#### Typography (`css/foundation/base/typography/index.css`)
...
#### Shadows (`css/foundation/base/shadows/index.css`)
...
#### Borders (`css/foundation/base/borders/index.css`)
...
#### Z-Index (`css/foundation/base/z-index/index.css`)
...
#### Avatar (`css/presentation/components/avatar/index.css`)
...
#### Button (`css/presentation/components/button/index.css`)
...
#### Input (`css/presentation/components/input/index.css`)
...
#### Card (`css/presentation/components/card/index.css`)
...
#### Modal (`css/presentation/components/modal/index.css`)
...
#### Transitions (`css/foundation/animations/transitions/index.css`)
...
#### Keyframes (`css/foundation/animations/keyframes/index.css`)
