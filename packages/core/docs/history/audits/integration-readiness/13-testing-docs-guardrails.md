...
- `ui-design-system/packages/core/scripts/check/architecture/conventions/folder-naming/index.mjs`

### Integration honesty checks

- `ui-design-system/packages/core/scripts/check/architecture/audits/integration/index.mjs`

### Taxonomy generation

- `ui-design-system/packages/core/docs/TAXONOMY.generated.md`
- `ui-design-system/packages/core/scripts/tooling/generation/taxonomy/index.mjs`
