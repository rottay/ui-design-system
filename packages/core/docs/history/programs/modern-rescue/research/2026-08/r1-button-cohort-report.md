...
- **Authority executed:** `packages/core/docs/history/programs/modern-rescue/research/2026-08/r1-button-opus-grammar.md` (GRAMMAR READY), items 1-15 of §2, laws G1-G10, fences of §6, DT adjudications (i)/(ii)/(iii) as handed down in the delegation prompt.
...
**PatternDataTable** — the round's own order (`rounds/index.json` R1 `objectives`: "attack Button then
