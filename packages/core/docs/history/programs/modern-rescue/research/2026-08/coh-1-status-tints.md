...
node packages/showroom/scripts/f4c-canary-capture.mjs packages/core/artifacts/quality/programs/modern-rescue/cascade-proofs/controls/palette-status-seeds/pre-derivation-five-phase-canary/phase-A --phase A
...
```
Matriz y comandos: `artifacts/quality/programs/modern-rescue/cascade-proofs/controls/palette-status-seeds/pre-derivation-five-phase-canary/README.md`.
