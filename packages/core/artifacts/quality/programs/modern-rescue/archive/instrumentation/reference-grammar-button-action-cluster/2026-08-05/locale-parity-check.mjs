 ...
 * for fr/pt read from i18n-baseline/index.json. That gate is NOT
...
const baselinePath = path.join(CORE_ROOT, 'scripts/i18n-baseline/index.json');
if (existsSync(baselinePath)) {
  committedBaselineForDeclaredPartialLocales = {
    source: 'packages/core/scripts/i18n-baseline/index.json, read-only, not re-seeded',
