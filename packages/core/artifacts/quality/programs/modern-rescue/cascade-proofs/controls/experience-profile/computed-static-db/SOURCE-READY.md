...
`docs/history/programs/architecture-refactor/2026-08/execution/index.md` (F4B progress row + a full
...
- `docs/history/programs/architecture-refactor/2026-08/execution/index.md` — the F4B progress row `3/20` -> `4/20`
