...
`stable-dom-part -> observable-property` (`customization-model/index.json:67`), no en
...
(`evidence-contract/index.json:76`). Cada drill perturba una observacion y **espera
