/**
 * leg1-symbolic.mjs — the cheap leg. No browser.
 *
 * WHAT IT ANSWERS
 ...
 * defect into a pass: `runtime/engines/classic/theme.css:22` declares
 * `html[data-tenant] { font-size: var(--ds-font-size-base) }`, and
 * `foundation/themes/default.css:610` defines that as
