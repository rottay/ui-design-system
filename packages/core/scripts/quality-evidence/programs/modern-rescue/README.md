...
`packages/core/manifest/generator/index.mjs`. Today it synchronizes registry,
...
`manifest/fanout-facts` as the single CSS dependency census after migrating any
