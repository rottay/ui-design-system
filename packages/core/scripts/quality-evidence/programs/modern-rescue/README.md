...
<!-- lane-control:program-state v1 — DO NOT EDIT BY HAND. Rewrite it with:
     ...
     head=e370a535a written=2026-08-27T06:43:24.155Z intent=5f3d9ae4d8aaee99 render=75c35209c8afd64c -->

*Everything in this section is intent. Anything derivable is derived by command, not typed here.*

**Current wave:** F3 — la pintura vive en las skins: piloto v3 CERRADO (2026-08-27; commit y asiento en §13 del roadmap). cell-renderers migrado al skin vía data-size con cero-delta computado; la condición Codex del 13px×3 resuelta por remoción (no reproduce ninguna seed del canal; el idioma del corpus es bare; el fallback era inalcanzable). F4B quedó completa en su forma honesta (los 20 controles asentados: nueve COMPUTED_VERIFIED, diez SOURCE_BOUND, chrome.families paraguas BY_REFERENCE) y F2 asimétrico cerrado como disposición, con diferidos de contrato/validador con dueño. La clasificación medida del pool supersede a las cifras históricas: 97 ocurrencias de producción, 31 dinámicas legítimas por mecanismo, superficie F3 genuina de un dígito. Cola inmediata: cohorte Typography/runtime (siete sitios — el residuo que sombrea al skin en cada render) con prueba de cero-delta propia, y el micro-fix C-02 del clear-button de textarea con mini-lote propio.
