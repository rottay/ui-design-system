...
test('the taxonomy chain is enforced, and freshness runs ahead of it', () => {
  ...
  const FRESHNESS_ARGV = [
    'node',
    'scripts/quality-evidence/programs/modern-rescue/manifest/generator.mjs',
    '--check',
  ];
...
test('the modern-rescue tooling drills are reachable, enforced, and run ahead of their gates', () => {
  ...
  const GENERATOR_DRILL = 'scripts/quality-evidence/programs/modern-rescue/manifest/generator.test.mjs';
