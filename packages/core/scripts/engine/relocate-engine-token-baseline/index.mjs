 ...
 *
 * Usage:
 *   node scripts/engine/relocate-engine-token-baseline/index.mjs
 *   node scripts/engine/relocate-engine-token-baseline/index.mjs --write
 *   node scripts/engine/relocate-engine-token-baseline/index.mjs \
 *     --old-root packages/core/src/components \
 *     --new-root packages/core/src/ui
 *   node scripts/engine/relocate-engine-token-baseline/index.mjs --adopt-new-zero
 */
