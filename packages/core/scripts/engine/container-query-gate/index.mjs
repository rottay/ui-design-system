 ...
 *
 * Usage:
 *   node scripts/engine/container-query-gate/index.mjs           # print the report
 *   node scripts/engine/container-query-gate/index.mjs --check   # exit 1 on any violation
 *   node scripts/engine/container-query-gate/index.mjs --seed    # (re)author the baseline from current reality
 */
