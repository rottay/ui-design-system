 ...
 *
 * Usage:
 *   node scripts/engine/anatomy-variant-gate/index.mjs            # print the report
 *   node scripts/engine/anatomy-variant-gate/index.mjs --check    # exit 1 on any violation
 *   node scripts/engine/anatomy-variant-gate/index.mjs --check --quiet
 *   (fixture overrides, for the self-test:)
 *   node scripts/engine/anatomy-variant-gate/index.mjs --check \
