...
const modernEnginePromise = postcss([tailwind()])
  ...
  .then((r) => unwrapRegisteredCustomProperties(r.css));

const modernEngine = await modernEnginePromise;

const baseCss = resolveImports(readFile(resolve(srcCss, 'facade/entrypoints/base.css')), resolve(srcCss, 'facade/entrypoints'));
...
const allTenantsCss = verticals
  ...
  .join('\n');
expected.set('styles/index.css', composeStylesBundle(baseCss, modernEngine, allTenantsCss));
