...
//
// Usage:
//   node scripts/packaging/pack-inventory-gate/index.mjs --check   (default)
//   node scripts/packaging/pack-inventory-gate/index.mjs --write    (re-seed baseline; refuses a dirty pack)
