...
// `parseModule` in `./lib/root-public-resolver.mjs`: no `ts.createProgram`, no
...
import { loadTypeScript } from '../../lib/taxonomy/root-public-resolver/index.mjs';
 ...
 */
const EXPECTED_SPECIFIER = '../../../../ui/patterns/visualization/charts/families';
...
test('planted negative: the right names re-exported from the wrong module', () => {
  const wrong = '../../../../ui/patterns/visualization/charts';
