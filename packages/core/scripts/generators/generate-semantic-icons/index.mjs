...
const GENERATED_HEADER = `// Generated by scripts/generators/generate-semantic-icons/index.mjs. Do not edit.\n\n`;
...
async function main() {
  ...
  if (args.includes('--help')) {
    console.log('Usage: node scripts/generators/generate-semantic-icons/index.mjs [--check]');
    return;
  }
