 ...
 * structures/dashboard/stats-header (dashboard anatomy inventory).
 *
...
const CERTIFIED_INLINE_STYLE_PRODUCERS = new Map([
  [
    "components/patterns/foundation/engine-styles/modern/index",
    new Map(
      [
        "cardBodyStyle",
  ...
  [
    "components/patterns/data/list-toolbar/foundation/tokens/index",
    new Map([["searchInputStyle", ownedStyle([{ index: 0, mode: "style" }])]]),
  ],
  [
    "components/primitives/feedback/toast/runtime/animation/index",
    new Map([["getToastAnimationStyle", ownedStyle()]]),
  ],
  [
    "components/primitives/runtime/overlay/portal-scope/index",
    new Map([
      [
        "usePortalScope",
        {
  ...
  [
    "components/primitives/display/tooltip/contracts/index",
    new Map([
      [
        "PLACEMENT_MAP",
        {
          ...
          consumers: new Map([
            [
              "components/primitives/display/tooltip/engines/rustic/index",
              new Set(["transform"]),
            ],
          ]),
        },
  ...
  [
    "components/primitives/layout/flex/runtime/presentation/index",
    new Map([
      [
  ...
  [
    "components/primitives/layout/stack/runtime/presentation/index",
    new Map([
      [
  ...
  [
    ...
    // foundation/animations/transitions/index.css own the paint.
  ...
  [
    ...
    "components/primitives/runtime/overlay/positioning/index",
    new Map([
      [
        "useOverlayPosition",
        {
  ...
  [
    ...
    "components/primitives/runtime/overlay/layer-stack/index",
    new Map([
      [
        "useOverlayLayer",
        {
  ...
  [
    ...
    "components/primitives/runtime/overlay/foundation/portal-theme/index",
    new Map([
      [
