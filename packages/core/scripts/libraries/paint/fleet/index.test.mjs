...
import { countArc09PaintInFile } from "../inline/index.mjs";
import { packageRoot as findPackageRoot } from "../../repo-root/index.mjs";

const HERE = dirname(fileURLToPath(import.meta.url));
const COMPONENTS_DIR = join(findPackageRoot(HERE), "src/components");
...
test("canonical density attributes are certified as a non-paint prop bag", () => {
  const markdownView = join(
    COMPONENTS_DIR,
    "primitives/display/markdown-view/index.tsx"
  );
  const canonical = `
