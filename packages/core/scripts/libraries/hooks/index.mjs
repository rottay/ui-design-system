 ...
 * --------------------
 * The independent audit (2026-07-26, independent code audit finding C3) recorded that the
 ...
 * That literal instruction cannot be followed: `contracts/runtime/suppliers/index.json` is the
...
export const PROMOTIONS = Object.freeze([
  Object.freeze({
    ...
    owner: 'the decorative command-grid overlay, `:where(.ds-command-grid)` in presentation/components/patterns/index.css',
  ...
  Object.freeze({
    ...
    owner: 'chart gridline/axis strokes in presentation/components/skin/chart-foundation/index.css',
  ...
  Object.freeze({
    ...
    owner: 'collection grid layout (surfaces render-dispatch, presentation/components/patterns/index.css)',
  ...
  try {
    ...
    throw new Error(
      `hook-manifest anchor MISSING: ${anchor.id} expected ${anchor.kind} at ${anchor.path}\n` +
        ...
        '  if the source moved, update ANCHORS in scripts/libraries/hooks/index.mjs.',
    );
  }
  ...
  return `${JSON.stringify(
    {
      ...
      generatedBy: 'scripts/check/boundaries/applications/hooks/index.mjs --manifest-write',
