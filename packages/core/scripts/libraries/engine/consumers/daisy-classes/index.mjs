...
import { paintedClassNames, readManifest } from '../../../../generate/framework-class-paint/index.mjs';
 ...
 * through an `import`. That preserves the independent code audit K2/K3 catch -- Message emitted
 ...
 * `../engine/daisy-painted-classes/index.mjs` and stored in `report/index.json`.
 *
 ...
 * legitimate class-position walk under `src/components` is 23 expression hops, so every
