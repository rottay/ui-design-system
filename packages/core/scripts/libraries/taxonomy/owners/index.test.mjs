// Self-test for the source-owner nesting detector.
//
...
const CLEAN_ROWS = [
  {
    ...
    sourceOwner: 'packages/core/src/components/structures/workspace/connected-command-palette',
  },
  {
    id: 'structure/workspace/search-command-bar',
    sourceOwner: 'packages/core/src/components/structures/workspace/search-command-bar',
  },
  {
    id: 'structure/workspace/table-toolbar',
    sourceOwner: 'packages/core/src/components/structures/workspace/table-toolbar',
  },
  {
    id: 'primitive/display/avatar',
    sourceOwner: 'packages/core/src/components/primitives/display/Avatar',
  },
];
...
const PLANTED_NESTED_ROWS = [
  ...
  {
    id: 'structure/workspace/search-command-bar',
    sourceOwner: 'packages/core/src/components/structures/workspace/connected-command-palette/search-command-bar',
  },
  {
    id: 'structure/workspace/table-toolbar',
    sourceOwner: 'packages/core/src/components/structures/workspace/table-toolbar',
...
test('planted negative: a deliberately nested sourceOwner is caught', () => {
  ...
  assert.deepEqual(violations[0], {
    ...
    outerOwner: 'packages/core/src/components/structures/workspace/connected-command-palette',
    innerId: 'structure/workspace/search-command-bar',
    innerOwner: 'packages/core/src/components/structures/workspace/connected-command-palette/search-command-bar',
  });
});

test('segment-boundary aware: a textual prefix that is not a path-segment ancestor is not a violation', () => {
  const rows = [
    { id: 'a', sourceOwner: 'packages/core/src/components/structures/workspace/table' },
    { id: 'b', sourceOwner: 'packages/core/src/components/structures/workspace/table-toolbar' },
  ];
...
test('rows sharing the exact same sourceOwner are not reported as nesting (a different defect)', () => {
  const rows = [
    { id: 'a', sourceOwner: 'packages/core/src/components/structures/workspace/table-toolbar' },
    { id: 'b', sourceOwner: 'packages/core/src/components/structures/workspace/table-toolbar' },
  ];
  assert.deepEqual(findNestedOwners(rows), []);
});
...
test('a three-level chain reports every ancestor/descendant pair, not just adjacent ones', () => {
  const rows = [
    { id: 'grandparent', sourceOwner: 'packages/core/src/components/patterns/data' },
    { id: 'parent', sourceOwner: 'packages/core/src/components/patterns/data/data-table' },
    { id: 'child', sourceOwner: 'packages/core/src/components/patterns/data/data-table/inline-edit' },
  ];
