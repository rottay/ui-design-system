 ...
 * La segunda fuente son los manifiestos de `governance/manifest/cascade/roots/**/index.json`.
...
test('control: presencia de declaracion por raiz — NO es severidad', () => {
  ...
  //   • manifiestos `governance/manifest/cascade/roots/**/index.json` .. 20 declaradas, 16
 ...
 *   • Ley aplicable: governance/manifest/cascade/roots/surfaces/elevation-posture/index.json —
