...
export function build() {
  ...
  return {
    $generatedBy: 'scripts/foundation/tokens/manifest/mirror-parity/index.mjs',
    $regenerate: 'node scripts/foundation/tokens/manifest/mirror-parity/index.mjs',
    $warning: [
...
if (invokedDirectly) {
  ...
  if (process.argv.includes('--check')) {
    ...
    if (current !== text) {
      console.error('✗ mirror-parity: generated/mirror-parity/index.json desactualizado — corre `node scripts/foundation/tokens/manifest/mirror-parity/index.mjs`');
      process.exit(1);
    }
