...
test('citeLiteral resuelve rutas con y sin el prefijo packages/core', () => {
  const conPrefijo = citeLiteral('packages/core/scripts/foundation/tokens/manifest/fanout/index.mjs', 'EXCLUDED_PREFIXES = [');
  const sinPrefijo = citeLiteral('scripts/foundation/tokens/manifest/fanout/index.mjs', 'EXCLUDED_PREFIXES = [');
