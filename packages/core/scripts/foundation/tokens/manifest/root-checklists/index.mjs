...
import { packageRoot as findPackageRoot } from '../../../../tooling/libraries/repo-root/index.mjs';
...
export const PROGRAM_ROOT = path.resolve(PACKAGE_ROOT, 'scripts/tooling/quality/evidence/programs/modern-rescue');
...
export const FACTS_GENERATOR_REL = 'scripts/foundation/tokens/manifest/fanout/index.mjs';
...
export function buildChecklists(
  ...
  return {
    generator: 'scripts/foundation/tokens/manifest/root-checklists/index.mjs',
    source: 'artifacts/generated/manifest/cascade/fanout/index.json',
    familyCanon: 'scripts/tooling/quality/evidence/programs/modern-rescue/family-inventory/index.json',
    corpusProvenance: {
      revertWave: [
