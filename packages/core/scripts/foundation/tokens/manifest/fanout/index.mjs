 ...
 *
 * Uso:
 *   node scripts/foundation/tokens/manifest/fanout/index.mjs
 *   node scripts/foundation/tokens/manifest/fanout/index.mjs --check
 */
...
export function buildFacts(packageRoot = PACKAGE_ROOT) {
  ...
  return {
    generator: 'scripts/foundation/tokens/manifest/fanout/index.mjs',
    scanRoot: SCAN_ROOT,
    planes: PLANES,
  ...
  if (check) {
    ...
    if (onDisk === null) {
      process.stderr.write(
        '✗ fanout-facts: falta generated/fanout-facts/index.json — corre el generador sin --check\n',
      );
      process.exit(1);
    }
    if (onDisk !== text) {
      process.stderr.write(
        '✗ fanout-facts: generated/fanout-facts/index.json esta desactualizado — corre el generador sin --check\n',
      );
      process.exit(1);
    }
    process.stdout.write('✓ fanout-facts: generated/fanout-facts/index.json al dia\n');
    return;
  }
