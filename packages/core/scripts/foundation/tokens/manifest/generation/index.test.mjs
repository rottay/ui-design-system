...
import { loadProgramContracts } from '../../../../tooling/quality/evidence/framework/contracts/index.mjs';
import { computeSourceDigest, sightedApprovers } from '../../../../tooling/quality/evidence/framework/receipts/index.mjs';
...
import { packageRoot as findPackageRoot, repoRoot as findRepoRoot } from '../../../../tooling/libraries/repo-root/index.mjs';

const HERE = dirname(fileURLToPath(import.meta.url));
const PACKAGE_ROOT = findPackageRoot(HERE);
const MANIFEST_ROOT = join(PACKAGE_ROOT, 'governance/manifest');
const PROGRAM_ROOT = join(PACKAGE_ROOT, 'scripts/tooling/quality/evidence/programs/modern-rescue');
...
test('bootstrap refuses to overwrite the existing manifest', () => {
  const result = spawnSync(
    process.execPath,
    ['packages/core/scripts/foundation/tokens/manifest/generation/index.mjs', '--bootstrap'],
...
const REAL_BINDING = 'packages/core/scripts/tooling/quality/evidence/programs/modern-rescue/README.md';
...
const CASCADE_FIXTURE_SITE =
  'packages/core/scripts/foundation/tokens/manifest/rules/index.mjs';
...
const VARIANTS_REASON =
  'CERO variantes por diseno: el eje es un escape hatch, no un vocabulario cerrado. Declarado en fuente, no tapado: packages/core/scripts/foundation/tokens/manifest/rules/index.mjs:1.';
...
const DERIVATIONS_REASON =
  'CERO derivaciones por diseno: el eje emite su canal cabeza y nadie deriva de el. Declarado en fuente, no tapado: packages/core/scripts/foundation/tokens/manifest/rules/index.mjs:1.';
