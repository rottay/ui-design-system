 ...
 *
 * Usage:
 *   node scripts/foundation/tokens/cascade/channels/consumers/index.mjs                # print the report
 *   node scripts/foundation/tokens/cascade/channels/consumers/index.mjs --check        # exit 1 on a NEW dead channel
 *   node scripts/foundation/tokens/cascade/channels/consumers/index.mjs --seed         # (re)author the baseline from the current dead set
 *   node scripts/foundation/tokens/cascade/channels/consumers/index.mjs --modern       # print the engine=modern four-state report
 *   node scripts/foundation/tokens/cascade/channels/consumers/index.mjs --modern-check # exit 1 on a NEW dead-in-modern channel
 *   node scripts/foundation/tokens/cascade/channels/consumers/index.mjs --modern-seed  # (re)author the modern baseline
 */
...
const baselinePath = join(here, 'baselines/all-engines/index.json');
const modernBaselinePath = join(here, 'baselines/modern/index.json');
