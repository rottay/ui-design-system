...
import { admitWriterLane, validateConflictGraph } from '../admission/index.mjs';
import { loadProgramContracts } from '../contracts/index.mjs';
import { scoreCraft } from '../craft-scoring/index.mjs';
import { evaluateFamilyEligibility } from '../eligibility/index.mjs';
import { analyzeOwnershipProposal } from '../ownership-overlap/index.mjs';
import { validateRoundEvidence } from '../rounds/evidence/index.mjs';
import { validateReceipts } from '../receipts/index.mjs';
import {
...
function usage() {
  return {
    usage: [
      ...
      'node packages/core/scripts/tooling/quality/evidence/framework/cli/index.mjs craft-score <family-receipt.json>',
      'node packages/core/scripts/tooling/quality/evidence/framework/cli/index.mjs eligibility <family-receipt.json>',
      'node packages/core/scripts/tooling/quality/evidence/framework/cli/index.mjs receipts <receipts.json>',
      'node packages/core/scripts/tooling/quality/evidence/framework/cli/index.mjs admission <lane-packet.json> <ownership-proposal.json>',
      'node packages/core/scripts/tooling/quality/evidence/framework/cli/index.mjs conflict-graph <conflict-graph.json>',
      'node packages/core/scripts/tooling/quality/evidence/framework/cli/index.mjs round-evidence <R0|R1|...>',
      'node packages/core/scripts/tooling/quality/evidence/framework/cli/index.mjs ownership <ownership-proposal.json>',
    ],
    laws: [
...
try {
  switch (command) {
    ...
    case 'family-matrix': {
      ...
      print({
        schemaVersion: 2,
        generatedBy: 'packages/core/scripts/tooling/quality/evidence/framework/cli/index.mjs family-matrix',
