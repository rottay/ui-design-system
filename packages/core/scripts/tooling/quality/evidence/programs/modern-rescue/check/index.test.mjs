...
const programDir = "packages/core/scripts/tooling/quality/evidence/programs/modern-rescue";
...
const CLOSURE_MEMBERS = [
  ...
  "packages/core/scripts/tooling/quality/evidence",
  "packages/core/scripts/tooling/libraries",
  "packages/core/scripts/foundation/tokens/manifest",
  "packages/core/scripts/foundation/tokens/customization/surface",
  "packages/core/scripts/foundation/tokens/customization/preservation",
  "packages/core/contracts/customization/public-css-hooks/index.json",
