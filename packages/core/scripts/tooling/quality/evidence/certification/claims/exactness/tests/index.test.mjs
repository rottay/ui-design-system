...
import { analyzeClaimSourceRecords } from '../../../../../../libraries/evidence/claim-analysis/index.mjs';
import { packageRoot as findPackageRoot } from '../../../../../../libraries/repo-root/index.mjs';

const HERE = dirname(fileURLToPath(import.meta.url));
const CORE_ROOT = findPackageRoot(HERE);
const FLOOR = JSON.parse(readFileSync(join(CORE_ROOT, 'scripts/tooling/quality/evidence/certification/claims/exactness/public-claim-floor/index.json'), 'utf8'));
