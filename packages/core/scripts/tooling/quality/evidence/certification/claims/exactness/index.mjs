...
import { summarizeZeroLocks } from '../../../../../libraries/engine/zero-lock-policy/index.mjs';
import { countArc09PaintInFile } from '../../../../../libraries/paint/inline-paint-counter/index.mjs';
import {
  ENGINE_TOKEN_EXACT,
  ENGINE_TOKEN_MINIMUM,
} from '../../../../../libraries/engine/token-governance/index.mjs';
import { readFirstPartyRosterSource } from '../../../../../libraries/verticals/first-party-roster-source/index.mjs';
import {
...
} from '../../../../../libraries/evidence/claim-analysis/index.mjs';
...
const BASELINE_PATH = join(CORE_ROOT, 'scripts/infrastructure/engine/tokens/audit/baseline/index.json');
const AUDIT_PATH = join(CORE_ROOT, 'scripts/infrastructure/engine/tokens/audit/index.mjs');
...
const SURFACE_PROFILE_OVERRIDE_ASSERTIONS = Object.freeze([
  'scripts/tooling/quality/evidence/certification/claims/exactness/tests/index.test.mjs',
