...
import {
  ...
  summarizeZeroLocks,
} from '../../../../../libraries/engine/zero-lock-policy/index.mjs';
import { countArc09PaintInFile } from '../../../../../libraries/paint/inline-paint-counter/index.mjs';
import { analyzeEmbeddedCssPaint } from '../../../../../libraries/paint/embedded-css-paint-counter/index.mjs';
import {
...
const AUDIT = join(CORE_ROOT, 'scripts/infrastructure/engine/tokens/audit/index.mjs');
