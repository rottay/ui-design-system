...
const GENERATED_ROOT = resolve(SEMANTIC_ROOT, 'generated');
const GENERATED_SCAN_ROOTS = Object.freeze([GENERATED_ROOT]);
...
const GENERATED_HEADER = `// Generated by scripts/generate/semantic-icons/index.mjs. Do not edit.\n\n`;
...
function generateCorpusModule(corpus) {
  ...
  return `${GENERATED_HEADER}import type { IconRole, IconTone } from '../../../glyphs/foundation/contracts';
...
import type { SemanticIconComponent, SemanticIconProps } from '../../runtime/create-icon';
${imports}
...
function generateFacadeMapModule() {
  ...
  const packSpreads = ICON_PACKS
    ...
    .join('\n');
  return `${GENERATED_HEADER}import type { SemanticIconComponent } from '../../runtime/create-icon';
${packImports}
...
${mappings}
} as const satisfies Record<string, SemanticIconComponent>);

export type BitHirePresetIconName = keyof typeof BITHIRE_PRESET_ICON_COMPONENTS;
export type BitHireIconPresetProps = SemanticIconProps & {
  readonly name: BitHirePresetIconName;
};

export const BITHIRE_PRESET_ICON_NAMES = Object.keys(
  BITHIRE_PRESET_ICON_COMPONENTS,
) as readonly BitHirePresetIconName[];
...
export function buildGeneratedFiles(corpus, adapter, bithirePreset) {
  ...
  files.set(
    'index.ts',
    `${GENERATED_HEADER}export * from './corpus';\nexport * from './packs';\n`,
  );
  return files;
}

function generatedOutputPath(logicalPath) {
  if (logicalPath === 'corpus.ts') return resolve(GENERATED_ROOT, 'corpus/index.ts');
  if (logicalPath === 'phosphor-adapter.ts') {
    return resolve(GENERATED_ROOT, 'phosphor-adapter/index.ts');
  }
  return resolve(GENERATED_ROOT, logicalPath);
}
...
async function main() {
  ...
  if (args.includes('--help')) {
    console.log('Usage: node scripts/generate/semantic-icons/index.mjs [--check]');
    return;
  }
