 ...
 *
 * Uso:
 *   node scripts/generate/tokens/manifest/fanout/index.mjs
 *   node scripts/generate/tokens/manifest/fanout/index.mjs --check
 */
...
export function buildFacts(packageRoot = PACKAGE_ROOT) {
  ...
  return {
    generator: 'scripts/generate/tokens/manifest/fanout/index.mjs',
    scanRoot: SCAN_ROOT,
    planes: PLANES,
