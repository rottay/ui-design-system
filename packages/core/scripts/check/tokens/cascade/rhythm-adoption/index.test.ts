...
const COVERED_FAMILIES = [
  ...
  { family: "workbench header", file: `${CSS_ROOT}/runtime/engines/modern/skin/workbench-header/index.css`, minimumSites: 4 },
  { family: "cockpit header", file: `${CSS_ROOT}/runtime/engines/modern/skin/cockpit-header/index.css`, minimumSites: 5 },
  { family: "detail panel", file: `${CSS_ROOT}/runtime/engines/modern/skin/detail-panel/index.css`, minimumSites: 4 },
  { family: "layout frame (header/content/footer room)", file: `${CSS_ROOT}/runtime/engines/modern/skin/layout/index.css`, minimumSites: 4 },
  { family: "card", file: `${CSS_ROOT}/runtime/engines/modern/skin/card/index.css`, minimumSites: 3 },
  { family: "form field", file: `${CSS_ROOT}/runtime/engines/modern/skin/form-field/index.css`, minimumSites: 2 },
  { family: "list toolbar", file: `${CSS_ROOT}/runtime/engines/modern/skin/list-toolbar/index.css`, minimumSites: 1 },
] as const;
