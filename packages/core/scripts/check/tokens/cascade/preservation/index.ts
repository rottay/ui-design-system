/**
 * Resolves default-state custom-property chains from shipped CSS bundles.
 * This proves propagation and restoration; browser layout remains a separate check.
 */
 ...
 *       ...
 *
 * That blind spot ran the OTHER way — 392 channels in `artifacts/generated/css/verticals/bithire/index.css` are
