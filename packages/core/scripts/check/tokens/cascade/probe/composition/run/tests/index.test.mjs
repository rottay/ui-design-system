 ...
 *
 * Run: node --test scripts/check/tokens/cascade/probe/composition/run/tests/index.test.mjs
 *
...
// The REAL synthetic control fixture (foundation/roster/fixtures/index.json),
...
// renders a real icon (see foundation/roster/fixtures/index.json's button-modern-md
