...
export function buildIngressInput({ armId, controlManifest, stopId, base = {} }) {
   ...
   * on independent audit's measurement). Since W-A an identity stop does not write
 ...
 * compiled output — which is exactly what `scripts/build/verticals/bundle-build/index.mjs`
 ...
 * (`node --test scripts/build/verticals/css-freshness/index.mjs` for the CSS,
 ...
 * `scripts/check/modern-rescue/cascade/governance/index.mjs`
