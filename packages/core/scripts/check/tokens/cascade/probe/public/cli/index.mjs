...
const DEFAULT_CAUSAL_NEGATIVE_DRILL = Object.freeze({
  ...
  proof:
    ...
    'scripts/check/tokens/cascade/probe/foundation/guards/tests/index.test.mjs ' +
    'scripts/check/tokens/cascade/probe/foundation/negative-controls/tests/index.test.mjs ' +
    'scripts/check/tokens/cascade/probe/composition/run/tests/index.test.mjs',
});
...
Bundle modes
  ...
  dist    the shipped bundle. Currently STALE: scripts/build/verticals/css-freshness/index.mjs
 ...
 *     (`src/components/primitives` is 1313 files) into the freshness surface, so an
  ...
  if (wantsReceipt) {
    ...
    const written = writeEvidence({
      ...
      receiptFields: {
        ...
        commandOrTool: 'node scripts/check/tokens/cascade/probe/public/cli/index.mjs data-causal',
        exitCode,
