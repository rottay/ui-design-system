 ...
 * `family-inventory/index.json`, and the verdict is computed from what is actually
 ...
 *
 * TWO CLOSED LOOPHOLES IN THAT MACHINERY (post independent-audit pass).
 *
 ...
 * in a component-local stylesheet under `src/components/**` paints exactly as hard as
...
/**
 * Defect 4 (independently reproduced bypasses). Recursively unwrap `:is()`, `:where()`
