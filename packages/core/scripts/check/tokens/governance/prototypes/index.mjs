 ...
 *
 * Usage:
 *   node scripts/check/tokens/governance/prototypes/index.mjs           # print the census
 *   node scripts/check/tokens/governance/prototypes/index.mjs --check   # exit 1 on any violation
 */
