 ...
 *
 * Usage:
 *   node scripts/check/boundaries/applications/styles/index.mjs            # report
 *   node scripts/check/boundaries/applications/styles/index.mjs --check    # enforce baseline
 */
...
const BASELINE = resolve(argValue('--baseline') ?? resolve(HERE, 'baseline/index.json'));
