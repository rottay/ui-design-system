 ...
 * `schema/index.json` because every check in this folder must run with no build,
...
import { laneCovers, loadContext, resolveLane } from '../../plans/index.mjs';
...
import { blockingGates } from '../../../automation/gates/manifest/index.mjs';

const HERE = dirname(fileURLToPath(import.meta.url));
export const SCHEMA_PATH = resolve(HERE, 'schema/index.json');

export const PROGRAM_STATE_PATH = 'packages/core/scripts/check/modern-rescue/README.md';
 ...
 *
 * AMENDED 2026-08-19 (owner decision, `docs/history/programs/architecture-refactor/2026-08/execution/index.md`
 ...
 */
export const CI_MANIFEST_PATH = 'packages/core/scripts/check/automation/gates/manifest/index.mjs';
...
export function validateWorkOrder(workOrder, { root, schema, context = null, skipRepoChecks = false } = {}) {
  ...
  for (const pathspec of workOrder.commitPathspecs) {
    ...
    // `packages/core/scripts`, which is NOT under `packages/core/scripts/maintain/codemods`,
