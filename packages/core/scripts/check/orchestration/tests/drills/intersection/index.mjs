...
import { loadContext, readPlan } from '../../../plans/index.mjs';
import {
...
const EXAMPLE_PLAN = `${ROOT}/packages/core/scripts/check/orchestration/plans/examples/index.json`;
...
export function runDrills() {
  ...
  return withTempDir('intersection', (dir) => {
        ...
        lanes: [
          {
            ...
            writeSet: ['packages/core/src/components/primitives/display/avatar/**', 'packages/core/src/foundation/tokens/css/**'],
          },
        ],
      }),
    });
        ...
        lanes: [
          {
            ...
            writeSet: ['packages/core/src/foundation/tokens/css/foundation/themes/default/index.css'],
        ...
        lanes: [
          {
            ...
            writeSet: ['packages/core/src/foundation/tokens/css/presentation/components/skin/button-icon/index.css'],
          },
        ],
      }),
    });
        ...
        lanes: [
          {
            ...
            writeSet: ['packages/core/src/foundation/tokens/css/runtime/engines/modern/skin/alert/index.css'],
          },
        ],
      }),
    });
    ...
    const SKIN_FILE = 'packages/core/src/foundation/tokens/css/presentation/components/skin/button-icon/index.css';
    suite.expectRefusal({
        ...
        lanes: [
          {
            ...
            writeSet: ['packages/core/src/components/primitives/inputs/button/**', SKIN_FILE],
    ...
    const OTHER_SKIN_FILE = 'packages/core/src/foundation/tokens/css/presentation/components/skin/alert-compounds/index.css';
    const disjointPlan = {
    ...
    const AVATAR_WRITE_SET = ['packages/core/src/components/primitives/display/avatar/**'];
    ...
    // this one.
    avatarRow.sourceOwner = 'packages/core/src/components/primitives/display/badge';
    ...
    vanishedInventory.rows.find((row) => row.id === 'primitive/display/avatar').sourceOwner =
      'packages/core/src/components/primitives/display/media/Avatar';
    ...
    suite.expectRefusal({
      ...
      result: run(
        process.execPath,
        [
          `${ROOT}/packages/core/scripts/check/orchestration/public/containment/index.mjs`,
          '--plan',
          EXAMPLE_PLAN,
          '--lane',
          'F1',
    ...
    suite.expectFact({
      ...
      ok:
        originalOwner === 'packages/core/src/components/primitives/display/avatar' &&
