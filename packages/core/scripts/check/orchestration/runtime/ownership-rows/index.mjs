 ...
 *
 * WHERE A FAMILY ROW COMES FROM. `family-inventory/index.json` is the canonical
 ...
 * document to update.
 *
 * The predecessor read `artifacts/quality/programs/modern-rescue/archive/ledgers/family-source-visitation/252-family-era/index.json`
 ...
 * in `../../public/work-order/synthetic-ownership/index.json` and go through identical
...
export const DEFAULT_SYNTHETIC_PATH = 'packages/core/scripts/check/orchestration/public/work-order/synthetic-ownership/index.json';
