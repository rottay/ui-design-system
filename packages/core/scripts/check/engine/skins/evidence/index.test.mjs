...
const FAMILY_SKINS = {
  'pattern/visualization/pattern-tree-view': {
    ...
    skins: [
      ...
      'packages/core/src/foundation/tokens/css/presentation/components/skin/tree-view-connector/index.css',
      // PatternTreeView -- `.ds-pattern-tree-view` / `.ds-tree-view-*`.
      'packages/core/src/foundation/tokens/css/runtime/engines/modern/skin/tree-view/index.css',
      'packages/core/src/foundation/tokens/css/runtime/engines/modern/skin/pattern-tree-view/index.css',
      'packages/core/src/foundation/tokens/css/runtime/engines/rustic/skin/pattern-tree-view/index.css',
    ],
  },
};
...
const SKIN_SELECTORS = {
  'presentation/components/skin/tree-view-connector/index.css': '.rt-tree-view',
  'runtime/engines/modern/skin/tree-view/index.css': '.ds-tree-view-modern',
  'runtime/engines/modern/skin/pattern-tree-view/index.css': '.ds-pattern-tree-view',
  'runtime/engines/rustic/skin/pattern-tree-view/index.css': '.ds-tree-view-rustic',
};
