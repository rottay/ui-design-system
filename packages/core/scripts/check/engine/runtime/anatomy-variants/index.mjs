 ...
 *
 * Usage:
 *   node scripts/check/engine/runtime/anatomy-variants/index.mjs            # print the report
 *   node scripts/check/engine/runtime/anatomy-variants/index.mjs --check    # exit 1 on any violation
 *   node scripts/check/engine/runtime/anatomy-variants/index.mjs --check --quiet
 *   (fixture overrides, for the self-test:)
 *   node scripts/check/engine/runtime/anatomy-variants/index.mjs --check \
