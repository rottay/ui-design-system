...
import { assertModernBundlesFrameworkFree, auditBundle } from './index.mjs';
...
function scaffold(bundleBody) {
  ...
  write('artifacts/generated/css/engines/modern/index.css', bundleBody);
...
function runOn(bundleBody) {
  ...
  try {
    return assertModernBundlesFrameworkFree({ packageRoot: f.root, bundles: ['artifacts/generated/css/engines/modern/index.css'] });
  } finally {
    f.cleanup();
  }
}
