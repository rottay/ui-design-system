...
import { ARC09_INLINE_PAINT_FILES } from '../../../../../../libraries/paint/fleet/index.mjs';
import { packageRoot as findPackageRoot } from '../../../../../../libraries/repo-root/index.mjs';

const scriptsDir = dirname(fileURLToPath(import.meta.url));
const packageRoot = findPackageRoot(scriptsDir);
const runtimeSvgCensus = resolve(scriptsDir, '../../../../css/paint/runtime-svg/index.mjs');
const tokenAudit = resolve(scriptsDir, '../../index.mjs');
