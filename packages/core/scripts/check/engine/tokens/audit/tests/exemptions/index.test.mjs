...
import { collectSkinExemptionFailures, countSkinExemptionBreaches } from '../../../../../../libraries/engine/skins/exemptions/index.mjs';

function fixture() {
  const dir = mkdtempSync(join(tmpdir(), 'skin-exemptions-'));
