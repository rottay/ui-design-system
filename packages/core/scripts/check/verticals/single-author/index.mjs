 ...
 *      `libraries/roster/index.mjs` — derived, never restated) and
 ...
 *
 * Usage:
 *   node scripts/check/verticals/single-author/index.mjs           # report
 *   node scripts/check/verticals/single-author/index.mjs --check   # exit 1 on findings
 */
 ...
 * The retired-identity gate assembles its own `RETIRED`. That gate
...
export const DEFAULT_PRODUCTION_FILES = Object.freeze([
  ...
  resolve(CORE_ROOT, 'scripts/build/verticals/bundle-build/index.mjs'),
]);
