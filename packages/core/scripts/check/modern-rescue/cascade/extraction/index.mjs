#!/usr/bin/env node
/**
 * index.mjs — WO-CRA-23 cascade, generated half (extractor).
 *
 ...
 *
 * Output: artifacts/generated/manifest/cascade/edges/index.json  (generated: true)
 *
...
const AUTHORED_CENSUS = {
  ...
  results: {
    ...
    discoveredBy: {
      ...
      citedSites: [
        "src/components/primitives/overlay/Tour/engines/modern/index.tsx:251 — style={{ ...style, ...portalScope.variables, zIndex, ['--ds-tour-mask-color' as any]: maskColor }}",
        "src/components/primitives/feedback/Modal/engines/modern/index.tsx:499 — ['--ds-overlay-modal-radius' as any]: panelRadius",
      ],
