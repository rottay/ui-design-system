...
import { analyzeClaimSourceRecords } from '../../../../../../libraries/evidence/claims/index.mjs';
import { packageRoot as findPackageRoot } from '../../../../../../libraries/repo-root/index.mjs';

const HERE = dirname(fileURLToPath(import.meta.url));
const CORE_ROOT = findPackageRoot(HERE);
const FLOOR = JSON.parse(readFileSync(join(CORE_ROOT, 'scripts/check/evidence/certification/claims/exactness/public-claim-floor/index.json'), 'utf8'));
...
const HEADER_CONSUMER = 'src/components/structures/headers/header-surface/index.tsx';
const SIDEBAR_OWNER = 'src/components/structures/shell/navigation/sidebar-surface/index.tsx';
const STRUCTURE_CONTRACT = 'src/components/structures/foundation/chrome/contracts/index.ts';
const SURFACES_CONTRACT = 'src/components/surfaces/foundation/contracts/index.ts';
