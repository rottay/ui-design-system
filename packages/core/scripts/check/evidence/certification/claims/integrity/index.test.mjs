...
function writeGat07Artifact(root) {
  ...
  writeJson(
    resolve(root, "packages/core/artifacts/quality/certification/claims/exactness/evidence/index.json"),
    {
      schemaVersion: 1,
      authority: "WO-GAT-07",
      scope:
  ...
  write(
    resolve(root, "packages/core/artifacts/quality/certification/claims/exactness/digest/index.txt"),
    `${semanticHash}\n`
  );
}
...
function writePublicCorpus(root, rootReadme) {
  ...
  write(resolve(root, "packages/core/docs/architecture/tenant-authority/index.md"), "Tenant model.\n");
  write(
    resolve(root, "packages/core/docs/architecture/ui-tiers/structures/index.md"),
    "Structures.\n"
  );
  write(
...
test("structural mode proves the contract while final mode cannot bypass live execution", () => {
  withFixture("gat09-integral-", (root) => {
    ...
    writeJson(
      resolve(root, "packages/core/scripts/check/evidence/certification/claims/integrity/public-claim-evidence/index.json"),
      evidenceMap([
        {
