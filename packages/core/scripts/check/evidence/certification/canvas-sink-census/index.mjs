...
export const CANVAS_SINK_MANIFEST = Object.freeze([
  ...
  Object.freeze({
    path: 'src/components/patterns/visualization/charts/runtime/exporting/foundation/file/index.ts',
    assetClass: 'functional-export',
    sinks: Object.freeze(['allocation:canvas', 'context:2d', 'encode:blob']),
  }),
  Object.freeze({
    path: 'src/components/primitives/display/qr-code/engines/classic/index.tsx',
    assetClass: 'functional-encoding',
    sinks: Object.freeze(['supplier:qr-encoder']),
  }),
  Object.freeze({
    path: 'src/components/primitives/display/qr-code/runtime/encoded-symbol/index.tsx',
    assetClass: 'functional-encoding',
    sinks: Object.freeze(['supplier:qr-encoder']),
  }),
  Object.freeze({
    path: 'src/components/primitives/overlay/watermark/runtime/canvas-pattern/index.ts',
