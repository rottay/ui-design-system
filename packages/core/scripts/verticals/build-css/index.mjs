 ...
 *
 * Usage:
 *   node scripts/verticals/build-css/index.mjs           # write dist/ and styles/ bundles
 *   node scripts/verticals/build-css/index.mjs --check    # fail if any styles/*.css is stale
 *
...
for (const vertical of verticals) {
  ...
  const bundle = [
    ...
    `/* Generated by scripts/verticals/build-css/index.mjs */`,
