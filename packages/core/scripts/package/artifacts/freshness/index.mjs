...
//
// This gate does not build; it fails with the exact build command instead.
//
// Usage:
//   node scripts/package/artifacts/freshness/index.mjs --check          (default)
//   node scripts/package/artifacts/freshness/index.mjs --check \
