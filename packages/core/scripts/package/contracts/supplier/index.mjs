...
// Committed, discoverable generator for packages/core/contracts/runtime/suppliers/index.json.
//
// WHAT THE CONTRACT IS
// --------------------
// contracts/runtime/suppliers/index.json is the precomputed supplier-reachability map of the
// design system's public API. Consuming apps ship a byte-identical snapshot and
// the app-side gate (src/entrypoints/suppliers/cli/index.mjs) reads it to decide which
// external supplier packages an app must declare when it imports a DS symbol.
// The DS-side gate (../../../../../../../scripts/check/dependencies/index.mjs -> auditCoreDependencyGraph)
...
// delegates to deriveSupplierContract() in ../../../../../../../scripts/check/dependencies/index.mjs, the
...
// only a source change can. The release build regenerates the committed file.
//
// SERIALIZATION
//   JSON.stringify(contract, null, 2) + "\n", written utf8. This is byte-for-
//   byte identical to the writer in ../../../../../../../scripts/check/dependencies/index.mjs
...
//   --path P  operate on P instead of the default contracts/runtime/suppliers/index.json.

import { readFileSync, writeFileSync } from 'node:fs';
import { dirname, resolve } from 'node:path';
import { fileURLToPath } from 'node:url';

import { deriveSupplierContract } from '../../../../../../scripts/check/dependencies/index.mjs';
import { packageRoot as findPackageRoot } from '../../../libraries/repo-root/index.mjs';

const SCRIPT_PATH = fileURLToPath(import.meta.url);
export const DEFAULT_CONTRACT_PATH = resolve(
  findPackageRoot(dirname(SCRIPT_PATH)),
  'contracts/runtime/suppliers/index.json',
);
