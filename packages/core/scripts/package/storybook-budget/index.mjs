 ...
 *
 * Validates that the local Storybook preview stays within
 ...
 *
 * Usage:
 *   node scripts/package/storybook-budget/index.mjs
 *   node scripts/package/storybook-budget/index.mjs --output-dir ./custom-storybook-static
 *
 * Exit codes:
 *   0 - within budget
...
let outputDir = join(ROOT, 'artifacts/local/previews/storybook');
