 ...
 *
 * FALLBACKS (semantica CORREGIDA 2026-08-27, correccion pre-2B pedida por Codex
 * via owner; caso ciclo-miembro por postaudit Fable del mismo lote). La regla
 ...
 *
 * CICLO Y FALLBACK (postaudit Fable 2026-08-27, sonda ejecutable): por
