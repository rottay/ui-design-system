 ...
 *
 * Usage:
 *   node scripts/tokens/tenant-channel-consumer-gate/index.mjs                # print the report
 *   node scripts/tokens/tenant-channel-consumer-gate/index.mjs --check        # exit 1 on a NEW dead channel
 *   node scripts/tokens/tenant-channel-consumer-gate/index.mjs --seed         # (re)author the baseline from the current dead set
 *   node scripts/tokens/tenant-channel-consumer-gate/index.mjs --modern       # print the engine=modern four-state report
 *   node scripts/tokens/tenant-channel-consumer-gate/index.mjs --modern-check # exit 1 on a NEW dead-in-modern channel
 *   node scripts/tokens/tenant-channel-consumer-gate/index.mjs --modern-seed  # (re)author the modern baseline
 */
