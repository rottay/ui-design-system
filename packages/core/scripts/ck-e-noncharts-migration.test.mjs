...
test('CK-E preserves shared Tree paint ownership and embedded structural CSS', () => {
  ...
  assert.match(rustic, /<style>\{`@keyframes pulse \{ 0%,100%\{opacity:1\} 50%\{opacity:\.4\} \}`\}<\/style>/);
});
