 ...
 * Zero external dependencies, minimal bundle size with CSS-only tooltip.
 */
...
// Placement to CSS class mapping for CSS-only positioning
...
/**
 * Apollo Tooltip - Native HTML + Tailwind implementation with CSS-only tooltip
 */
