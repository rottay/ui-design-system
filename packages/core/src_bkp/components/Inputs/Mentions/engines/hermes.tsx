...
/**
 * Hermes Mentions Component
 *
 * DaisyUI-styled mentions input with dropdown.
 */
export default function HermesMentions(props: MentionsProps) {
  const {
