...
`AGENTS.md 8043c82e…`, `CLAUDE.md 142b2e5d…`, `modern-rescue/README.md 73aefa99…`, `agent-orchestration.json 2ea3078e…`, `customization-model.json 749e60bc…`, `program-check.mjs b35c1614…`, `program-check.test.mjs 47fcb19d…` (full 64-hex values verified; all seven matched). Staging index: **empty (0)**. No product path was touched by this audit.
...
- This file: `packages/core/test-artifacts/quality-evidence/wo-cra-23/advisory/2026-08-14-t1-agent-constitution-fable-postaudit.md`. Its SHA-256 is stated in the accompanying reply (a file cannot embed its own final hash).
