...
`agent-orchestration.json:4-17` codifies `doubleAccept`: scoped law ("not itself a commit
...
Namespace triad + deny-list + drainLaw (`customization-model.json:5-51`), transportEquality five
