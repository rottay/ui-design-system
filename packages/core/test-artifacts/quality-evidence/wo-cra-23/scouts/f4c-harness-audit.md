...
(2165 líneas) contra su contrato `packages/core/test-artifacts/quality-evidence/wo-cra-23/F4C/README.md`.
...
`evidence-contract.json:76` de que el comparador MUERDE la violación nombrada;
