 ...
 * `scripts/i18n-key-parity-gate.baseline.json` is not this lane's to move: a
...
async function main() {
  ...
  try {
    ...
    const baselinePath = path.join(repoRoot, 'packages', 'core', 'scripts', 'i18n-key-parity-gate.baseline.json');
