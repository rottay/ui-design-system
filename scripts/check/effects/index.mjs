...
// levels below scripts/ (scripts/check/effects/index.mjs),
...
const DEFAULT_PROVENANCE_ROOT = resolve(
  REPO_ROOT,
  'packages/core/governance/effects',
);
...
export function auditEffectProvenance(
  ...
  const errors = [];
  const ledgerPath = resolve(provenanceRoot, 'sources/index.json');
  ...
  const archivedLicenses = readdirSync(licenseDirectory, { withFileTypes: true })
