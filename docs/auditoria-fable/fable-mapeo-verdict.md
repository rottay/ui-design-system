...
| `src/tooling/resolution-probe/runtime/bundle/index.mjs:40` (import ESM) | `scripts/lib/modern-framework-layer.mjs` | I |
| `src/tooling/resolution-probe/foundation/scope/index.mjs:35` (import ESM) | `scripts/lib/first-party-roster-source.mjs` | I |
| `src/tooling/lane-control/public/work-order/index.mjs:49` (import de `blockingGates`) y `:88` (`CI_MANIFEST_PATH`) | `scripts/ci-gates.manifest.mjs` | F |
...
| `src/tooling/lane-control/integration/tests/drills/work-order/index.mjs:117` + `public/work-order/examples/wo-example.json:51` (comando debe seguir REGISTRADO en el manifiesto) | `scripts/engine-token-audit.mjs` | H (cuando F2 reescribe el path del manifiesto) |
...
**Evidencia:** `scripts/boundaries/dependency-honesty/index.mjs:23`:
...
**Evidencia:** `scripts/provenance/effect-registry-audit/index.test.mjs:9`
importa `../../../packages/core/scripts/ci-gates.manifest.mjs`, y `:204`
...
pineado en `scripts/provenance/effect-registry-audit/index.mjs:119` dicen
...
`../../../scripts/provenance/effect-registry-audit/index.mjs`
...
- No verifiqué F9 (las ~70 citas de docs) fila por fila; asumo el conteo del
  mapeo. Tampoco `docs/MAPA-DEL-REPO.md` contra el árbol.
