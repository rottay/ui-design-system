...
Fuentes: `packages/core/manifest/cascade/root-catalog.json` (64 raíces) y
...
|---|---|---|---|---|
| 1 | Σassignments = 261 = 95+96+70 | **rottay 95 · bithire 96 · evnto 70 · total 261** | `python3 -c "import json; d=json.load(open('packages/core/manifest/cascade/root-catalog.json')); roots=d['roots']; tot={'rottay':0,'bithire':0,'evnto':0}; [tot.update({k: tot[k]+r['assignments'].get(k,0)}) for r in roots for k in tot]; print(tot, sum(tot.values()))"` | ✓ exacto |
