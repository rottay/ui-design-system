...
Opus, pero el **censo AST canónico** (`scripts/tokens/customization-surface-census/`)
...
- **core**: `scripts/tokens/customization-surface-census/customization-surface-report.json`
