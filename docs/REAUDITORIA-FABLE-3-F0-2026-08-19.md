...
("piso honesto") declarado en `docs/ROADMAP-EJECUCION-2026-08-19.md` §13,
commit de cierre `c81e9414e`. Rondas previas:
[`REAUDITORIA-FABLE-2026-08-19.md`](REAUDITORIA-FABLE-2026-08-19.md) y
[`REAUDITORIA-FABLE-2-EJECUCION-2026-08-19.md`](REAUDITORIA-FABLE-2-EJECUCION-2026-08-19.md).
...
CONFIRMADO. Solo `probe/cascade-probe.mjs` + su test cayeron; la sonda raíz
...
- `packages/core/scripts/tokens-catalog.mjs:963,1105` — el propio generador
