...
> `docs/history/programs/architecture-refactor/2026-08/execution/index.md` §13 (mismo directorio); si algo acá
...
2. **Cadena de regeneración COMPLETA** (F4A-6 la fijó): censo → reconciliation
   ...
   VOS** (`node scripts/check/evidence/certification/claims/exactness/index.mjs --write` luego
...
11. **Actualizá §13 con cada lote** — es la única verdad resumible. Y este
    ...
    `docs/history/prompts/architecture-refactor/2026-08/coordination-continuation/index.md`; mantenelos coherentes).
12. **Byte-idéntico** en lotes de solo-comentarios: builds REALES ida y
    ...
    entrypoints viven en `packages/core/contracts/package/entrypoints/index.json` y
...
tail -120 docs/history/programs/architecture-refactor/2026-08/execution/index.md   # §13, la verdad viva
```
