...
> K3) — veredicto y correcciones en `docs/history/programs/architecture-refactor/2026-08/execution/index.md`
...
1. La autoridad de estado está desactualizada.
   program/index.json (línea 8) declara roadmap/registry.json como autoridad, pero
