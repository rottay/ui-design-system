...
Propuesta: `governance/manifest/cascade/variant-assignments.json` (schemaVersion'd),
generado desde los tags de fuente por un productor — nunca editado a mano.
Si algún gate lo lee, su schema se fija primero en `scripts/foundation/tokens/scripts/foundation/tokens/manifest/rules.mjs`
