...
Documento de decisión. El mapa (`docs/history/inventories/repository-map/2026-08/index.md`) dice qué hay; este dice
qué hacemos con eso.
...
([`docs/history/audits/architecture-refactor/2026-08/coordination/index.md`](/docs/history/audits/architecture-refactor/2026-08/coordination/index.md)); sus correcciones ya están
...
**se quedan** los 7 que sí tienen trabajo: `scripts/check/dependencies/index.mjs` (+ test),
`scripts/check/effects/index.mjs` (+ test, y este sí corre en CI), `scripts/maintain/roadmap/status/index.mjs`
(+ test), `scripts/maintain/roadmap/commercial-status/index.mjs`.
...
```
packages/core/scripts/check/modern-rescue/probe/index.mjs       (2.729 líneas)
packages/core/scripts/check/modern-rescue/probe/index.test.mjs  (692 líneas)
```
...
(`modern-rescue/index.mjs`, 776 líneas) está partida en módulos y los
...
(`index.mjs`, `index.mjs`, `index.mjs`, `index.mjs`,
`index.mjs`) son **dependencia directa** de la sonda de la raíz, que los
...
**propuesta:** un solo árbol, `packages/core/artifacts/quality/` (que está 100 %
...
- `contracts/runtime/suppliers/index.json` y los manifiestos de modern-rescue, que fallan
  cerrado.
...
mapa: `grep "audit-presets\|audit-report" docs/history/inventories/repository-map/2026-08/index.md` da **0**. El
...
`scripts/maintain/roadmap/status/index.mjs` (3.177 líneas) y `scripts/maintain/roadmap/commercial-status/index.mjs` (304).
...
**Ejecutado:** `packages/core/ARCHITECTURE.md` fue retirado; la autoridad local
única quedó en `docs/ARCHITECTURE.md` y los anexos mecánicos activos quedaron
bajo `packages/core/docs/architecture/`. Auditorías y programas anteriores se
clasificaron en `packages/core/docs/history/`; generados, referencias, guías y
calidad tienen owners separados con entrada `index.md`.
...
|---|---|---|
| `modern-rescue/probe/` (5 archivos) | la carpeta se llamó "segunda implementación" | `index.mjs` de la raíz los importa en sus líneas 76-84 |
...
| `scripts/maintain/codemods/**/index.mjs` | ningún script npm los corre | por diseño: se corren a mano en el repo de la app consumidora |
...
declara qué diverge y un test lo verifica. `scripts/maintain/roadmap/commercial-status/index.mjs` declaró
...
```
scripts/libraries/first-party-roster-source.test.mjs
scripts/libraries/modern-framework-layer.test.mjs
scripts/libraries/owner-nesting.test.mjs
scripts/libraries/root-public-resolver.test.mjs
scripts/tooling/quality/evidence/programs/modern-rescue/cascade/probe/orchestration/index.test.mjs
scripts/tooling/quality/evidence/programs/modern-rescue/scripts/foundation/tokens/manifest/fanout.test.mjs
scripts/tooling/quality/evidence/programs/modern-rescue/scripts/foundation/tokens/scripts/foundation/tokens/manifest/mirror-parity.test.mjs
scripts/tooling/quality/evidence/programs/modern-rescue/scripts/foundation/tokens/scripts/foundation/tokens/manifest/root-checklistss.test.mjs
scripts/tooling/quality/evidence/programs/modern-rescue/probe/index.test.mjs
```

Son 9 de 97. Los cuatro de `scripts/libraries/` prueban los módulos compartidos que
