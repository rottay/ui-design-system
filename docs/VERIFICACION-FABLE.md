...
2. **L20 `scripts/roadmap-commercial-status.mjs`**: no "reimplementa desde cero sin compartir ni una línea" — su header declara "Copied from ui-design-system scripts/roadmap-status.mjs (2026-07-07) ... Byte-identical EXCEPT for exactly TWO functional divergences", y comparte 191 líneas idénticas; es copia divergida (el original creció a 3177).
