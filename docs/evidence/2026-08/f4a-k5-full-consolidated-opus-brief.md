...
| 5 | `…/packages/core/manifest/variant-parity/baseline/index.json` | **mano** | — | **UNA sola Baja #14: 40 → 0**. Tras editar: `--check` verde, contador **0**, `divergentSlots` **33**, `tagRegistry` **4155** |
