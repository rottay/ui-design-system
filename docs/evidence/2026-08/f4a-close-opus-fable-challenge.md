...
- `checkpoint/index.json.blockedOn`: **falso en los dos sentidos que Opus declara** — leí el archivo entero: omite `gates:ci` final (repite ítems 1, 2, 4 del roadmap `:1725-1729`, no "los 3 primeros") y abre con "No external blocker." mientras K4 espera a Kimi (bloqueo verificado por ausencia de memo+flag).
