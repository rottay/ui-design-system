...
/**
 * PlMenuRoleAssignment - Matrix Preset
...
export const MatrixPlMenuRoleAssignment = createPreset<PlMenuRoleAssignmentProps>({
  name: 'PlMenuRoleAssignment.Matrix',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlMenuRoleAssignmentProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Menu Role Assignment</h2>
