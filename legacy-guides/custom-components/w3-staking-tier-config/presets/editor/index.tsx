...
/**
 * W3StakingTierConfig - Editor Preset
...
export const EditorW3StakingTierConfig = createPreset<W3StakingTierConfigProps>({
  name: 'W3StakingTierConfig.Editor',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3StakingTierConfigProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Staking Tier Config</h2>
