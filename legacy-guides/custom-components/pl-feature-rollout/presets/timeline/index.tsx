...
/**
 * PlFeatureRollout - Timeline Preset
...
export const TimelinePlFeatureRollout = createPreset<PlFeatureRolloutProps>({
  name: 'PlFeatureRollout.Timeline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlFeatureRolloutProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Feature Rollout</h2>
