...
export const GradientPreset = createPreset<AnnouncementBannerProps>((context) => {
  ...
  return (
    <Box
      ...
      style={{
        ...
        background: `linear-gradient(90deg, ${tokens.colors.primaryScale[500]} 0%, ${tokens.colors.primaryScale[700]} 100%)`,
...
GradientPreset.displayName = 'AnnouncementBannerGradientPreset';
