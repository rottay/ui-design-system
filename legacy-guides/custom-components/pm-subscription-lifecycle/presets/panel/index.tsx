...
/**
 * PmSubscriptionLifecycle - Panel Preset
...
export const PanelPmSubscriptionLifecycle = createPreset<PmSubscriptionLifecycleProps>({
  name: 'PmSubscriptionLifecycle.Panel',
