...
export const PanelPmWebhookDetail = createPreset<PmWebhookDetailProps>({
  name: 'PmWebhookDetail.Panel',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmWebhookDetailProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Webhook Detail</h2>
