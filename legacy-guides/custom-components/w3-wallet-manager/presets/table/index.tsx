...
export const TableW3WalletManager = createPreset<W3WalletManagerProps>({
  name: 'W3WalletManager.Table',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3WalletManagerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Wallet Manager</h2>
