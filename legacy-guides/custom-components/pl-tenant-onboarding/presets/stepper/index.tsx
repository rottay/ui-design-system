...
/**
 * PlTenantOnboarding - Stepper Preset
...
export const StepperPlTenantOnboarding = createPreset<PlTenantOnboardingProps>({
  name: 'PlTenantOnboarding.Stepper',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlTenantOnboardingProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Tenant Onboarding</h2>
