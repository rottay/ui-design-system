...
/**
 * PmSubscriptionCreate - Wizard Preset
...
export const WizardPmSubscriptionCreate = createPreset<PmSubscriptionCreateProps>({
  name: 'PmSubscriptionCreate.Wizard',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmSubscriptionCreateProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Subscription Create</h2>
