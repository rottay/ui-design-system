...
export const WizardW3TokenDeploy = createPreset<W3TokenDeployProps>({
  name: 'W3TokenDeploy.Wizard',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3TokenDeployProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Token Deploy</h2>
