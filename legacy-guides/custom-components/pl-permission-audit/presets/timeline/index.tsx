...
/**
 * PlPermissionAudit - Timeline Preset
...
export const TimelinePlPermissionAudit = createPreset<PlPermissionAuditProps>({
  name: 'PlPermissionAudit.Timeline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlPermissionAuditProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Permission Audit</h2>
