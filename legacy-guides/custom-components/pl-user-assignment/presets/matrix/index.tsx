...
/**
 * PlUserAssignment - Matrix Preset
...
export const MatrixPlUserAssignment = createPreset<PlUserAssignmentProps>({
  name: 'PlUserAssignment.Matrix',
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>User Assignment</h2>
