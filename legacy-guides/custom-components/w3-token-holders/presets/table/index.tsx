...
export const TableW3TokenHolders = createPreset<W3TokenHoldersProps>({
  name: 'W3TokenHolders.Table',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3TokenHoldersProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Token Holders</h2>
