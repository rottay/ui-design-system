...
/**
 * W3CertificateVerification - Badge Preset
...
export const BadgeW3CertificateVerification = createPreset<W3CertificateVerificationProps>({
  name: 'W3CertificateVerification.Badge',
