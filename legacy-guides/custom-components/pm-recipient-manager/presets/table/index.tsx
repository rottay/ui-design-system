...
/**
 * PmRecipientManager - Table Preset
...
export const TablePmRecipientManager = createPreset<PmRecipientManagerProps>({
  name: 'PmRecipientManager.Table',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmRecipientManagerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Recipient Manager</h2>
