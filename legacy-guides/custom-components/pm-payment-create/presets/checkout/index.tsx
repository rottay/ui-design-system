...
/**
 * PmPaymentCreate - Checkout Preset
...
export const CheckoutPmPaymentCreate = createPreset<PmPaymentCreateProps>({
  name: 'PmPaymentCreate.Checkout',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmPaymentCreateProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Payment Create</h2>
