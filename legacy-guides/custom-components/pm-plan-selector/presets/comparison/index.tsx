...
/**
 * PmPlanSelector - Comparison Preset
...
export const ComparisonPmPlanSelector = createPreset<PmPlanSelectorProps>({
  name: 'PmPlanSelector.Comparison',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmPlanSelectorProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Plan Selector</h2>
