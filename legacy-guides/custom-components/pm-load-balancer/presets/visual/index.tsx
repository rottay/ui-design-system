...
export const VisualPmLoadBalancer = createPreset<PmLoadBalancerProps>({
  name: 'PmLoadBalancer.Visual',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmLoadBalancerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Load Balancer</h2>
