...
export const WidgetW3OnrampWidget = createPreset<W3OnrampWidgetProps>({
  name: 'W3OnrampWidget.Widget',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3OnrampWidgetProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>On-Ramp Widget</h2>
