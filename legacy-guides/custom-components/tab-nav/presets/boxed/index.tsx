      ...
      {items.map((item, idx) => (
        <Box
          ...
          style={{
            ...
            backgroundColor:
              activeKey === item.key ? tokens.colors.common.white : tokens.colors.neutral[50],
            borderRight:
              idx < items.length - 1 ? `${tokens.surface.borderWidth} ${tokens.surface.borderStyle} ${tokens.colors.neutral[200]}` : 'none',
        ...
        >
          {item.icon && (
            <Box
              style={{
                ...
                color:
                  activeKey === item.key ? tokens.colors.primaryScale[600] : tokens.colors.neutral[600],
              }}
            >
              {item.icon}
            </Box>
          ...
          <Text
            style={{
              ...
              color:
                activeKey === item.key ? tokens.colors.neutral[900] : tokens.colors.neutral[600],
            }}
          >
            {item.label}
          </Text>
