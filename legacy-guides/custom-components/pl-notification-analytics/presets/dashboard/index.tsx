...
/**
 * PlNotificationAnalytics - Dashboard Preset
...
export const DashboardPlNotificationAnalytics = createPreset<PlNotificationAnalyticsProps>({
  name: 'PlNotificationAnalytics.Dashboard',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlNotificationAnalyticsProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Notification Analytics</h2>
