...
/**
 * PlNavigationFavorites - List Preset
...
export const ListPlNavigationFavorites = createPreset<PlNavigationFavoritesProps>({
  name: 'PlNavigationFavorites.List',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlNavigationFavoritesProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Navigation Favorites</h2>
