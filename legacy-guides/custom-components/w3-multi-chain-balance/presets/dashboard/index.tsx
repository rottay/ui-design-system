...
/**
 * W3MultiChainBalance - Dashboard Preset
...
export const DashboardW3MultiChainBalance = createPreset<W3MultiChainBalanceProps>({
  name: 'W3MultiChainBalance.Dashboard',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3MultiChainBalanceProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Multi-Chain Balance</h2>
