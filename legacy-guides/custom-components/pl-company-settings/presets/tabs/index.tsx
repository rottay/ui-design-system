...
export const TabsPlCompanySettings = createPreset<PlCompanySettingsProps>({
  name: 'PlCompanySettings.Tabs',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlCompanySettingsProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Company Settings</h2>
