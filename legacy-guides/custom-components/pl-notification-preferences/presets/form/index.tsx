...
/**
 * PlNotificationPreferences - Form Preset
...
export const FormPlNotificationPreferences = createPreset<PlNotificationPreferencesProps>({
  name: 'PlNotificationPreferences.Form',
