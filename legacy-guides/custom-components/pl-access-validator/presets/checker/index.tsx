...
/**
 * PlAccessValidator - Checker Preset
...
export const CheckerPlAccessValidator = createPreset<PlAccessValidatorProps>({
  name: 'PlAccessValidator.Checker',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlAccessValidatorProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Access Validator</h2>
