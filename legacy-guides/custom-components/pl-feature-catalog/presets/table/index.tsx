...
export const TablePlFeatureCatalog = createPreset<PlFeatureCatalogProps>({
  name: 'PlFeatureCatalog.Table',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlFeatureCatalogProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Feature Catalog</h2>
