...
/**
 * PmPayoutDetail - Timeline Preset
...
export const TimelinePmPayoutDetail = createPreset<PmPayoutDetailProps>({
  name: 'PmPayoutDetail.Timeline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmPayoutDetailProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Payout Detail</h2>
