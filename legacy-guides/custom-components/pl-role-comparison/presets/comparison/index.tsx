...
/**
 * PlRoleComparison - Comparison Preset
...
export const ComparisonPlRoleComparison = createPreset<PlRoleComparisonProps>({
  name: 'PlRoleComparison.Comparison',
  render: ({ primitives, props, tokens, engine }: PresetContext<PlRoleComparisonProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Role Comparison</h2>
