...
/**
 * PmRefundDetail - Timeline Preset
...
export const TimelinePmRefundDetail = createPreset<PmRefundDetailProps>({
  name: 'PmRefundDetail.Timeline',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmRefundDetailProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Refund Detail</h2>
