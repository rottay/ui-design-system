...
/**
 * W3SessionKeyManager - Table Preset
...
export const TableW3SessionKeyManager = createPreset<W3SessionKeyManagerProps>({
  name: 'W3SessionKeyManager.Table',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3SessionKeyManagerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Session Key Manager</h2>
