...
/**
 * PlPrivacyManager - Wizard Preset
...
export const WizardPlPrivacyManager = createPreset<PlPrivacyManagerProps>({
  name: 'PlPrivacyManager.Wizard',
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Privacy Manager</h2>
