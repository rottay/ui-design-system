...
/**
 * PmPaymentMethodSelector - List Preset
...
export const ListPmPaymentMethodSelector = createPreset<PmPaymentMethodSelectorProps>({
  name: 'PmPaymentMethodSelector.List',
  render: ({ primitives, props, tokens, engine }: PresetContext<PmPaymentMethodSelectorProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>Payment Method Selector</h2>
