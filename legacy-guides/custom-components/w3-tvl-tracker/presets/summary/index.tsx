...
export const SummaryW3TvlTracker = createPreset<W3TvlTrackerProps>({
  name: 'W3TvlTracker.Summary',
  render: ({ primitives, props, tokens, engine }: PresetContext<W3TvlTrackerProps>) => {
    ...
    return (
      <div className={className} style={{ ...containerStyle, ...style }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: tokens.spacing[6] }}>
          <div>
            <h2 style={headerStyle}>TVL Tracker</h2>
